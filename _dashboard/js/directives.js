        ...
        link: function (scope) {
            ...
            scope.actions.checkItem = function (entity, list, action) {
                ...
                result = _.find(list, function (num) {
                    ...
                    return (entity.id) ? main && num['cnv_id'] !== entity.id : main;
                });
                (!result) ? scope.actions[action]() : scope.actions.checked();
            };
            scope.actions.reset = () => {
        ...
        link: function (scope) {
            ...
            scope.actions.checkItem = function (entity, list, action) {
                ...
                result = _.find(list, function (num) {
                    ...
                    return (entity.id) ? main && num['riv_id'] !== entity.id : main;
                });
                (!result) ? scope.actions[action]() : scope.actions.checked();
            };
            scope.actions.reset = () => {
        ...
        link: function (scope) {
            ...
            scope.updateCheck = function () {
                return (
                    ...
                    !scope.entity.telefono ||
                    !scope.entity.email
                );
            };
            scope.actions = new $rootScope.Actions(scope, 'agenti');
            scope.actions.checkItem = function (entity, list, action) {
                let result;
                result = _.find(list, function (num) {
                    let main = num['agenti_nome'] === entity.nome && num['agenti_email'] === entity.email && num['agenti_riv'] === entity.rivenditore;
                    return (entity.id) ? main && num['agenti_id'] !== entity.id : main;
                });
                (!result) ? scope.actions[action]() : scope.actions.checked();
            };
            scope.actions.reset = () => {
