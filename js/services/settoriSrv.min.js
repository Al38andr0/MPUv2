...
(function(){function a(a,c,f,b){var d=f+"settori.php",l=new window.Mixin,k=function(a,b){switch(a){case "categoria":switch(b){case "mobili per ufficio":return"Arredi";case "sedute per ufficio":return"Sedute";case "pareti divisorie":return"Pareti";case "accessori per ufficio":return"Accessori";case "art & design":return"Art & Design"}break;case "settore":return-1!==b.indexOf("arredi")?b.replace("arredi","ambienti"):b}};return{getAll:function(h,g){a.get(d,{params:{action:"getAll"},cache:!0}).then(function(a){c.debugConsole&&
console.log("GET ALL settori: SUCCESS",a);if(h){var e={list:[]},g=[];b.each(a.data,function(a){b.contains(g,a.cat_id)||(g.push(a.cat_id),e.list.push({nome:a.cat_nome,url:l.generateUrl(a.cat_nome),title:k("settore",a.set_nome),id:parseInt(a.cat_id),posizione:parseInt(a.cat_pos),settori:[]}));var c=g.indexOf(a.cat_id);e.list[c].settori.push({nome:a.set_nome,url:l.generateUrl(a.set_nome),title:k("settore",a.set_nome),id:parseInt(a.set_id)})});return h(e)}},function(a){c.debugConsole&&console.log("GET ALL settori: FAIL",
...
target:"_blank",restrict:"mpu"}]},extractCategorie:function(a,c){var e=[],g=[],d=[],f=[];b.each(c,function(a){e.push(a.categoria);d.push(a.settori)});b.each(c,function(a){f.push(a.linee)});f=b.flatten(f);e=b.uniq(b.flatten(e));d=b.uniq(b.flatten(d));b.each(e,function(c){var e=b.find(a,function(a){return a.id===c}),h={nome:e.nome,url:l.generateUrl(e.nome),titolo:k("categoria",e.nome),id:e.id,posizione:e.posizione,settori:[]};b.each(e.settori,function(a){a.linee=b.filter(f,function(c){return b.contains(c.settore,
...
createTitle:k}}angular.module("mpu").service("settoriSrv",a);a.$inject=["$http","$rootScope","API","_"]})();
