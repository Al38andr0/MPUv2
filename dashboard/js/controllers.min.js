...
function(){c.saving=!0;var m=a.buildBody();m.id=a.entity.id;b.post("php/"+l+".php?type=delete",JSON.stringify(m)).then(this.success,this.fail)};this.cleanInputFile=function(){angular.forEach(angular.element("input[type='file']"),function(a){angular.element(a).val(null)})}};c.settings={itemsPerPage:5,query:{},tooltip:"top",show:function(a,b){return a>=(b-1)*c.settings.itemsPerPage&&a<b*c.settings.itemsPerPage},convert:function(a,b,l,d){if(c[b])return k.find(c[b],function(b){return parseInt(b[l])===
parseInt(a)})[d]},parse:function(a){return JSON.parse(a)},generateObject:function(a,b,l){var m=[];k.each(c[a],function(a){var c=parseInt(a[b+"_id"]);m.push({id:c,nome:a[b+"_nome"],checked:l?-1!==l.indexOf(c):!1})});return m},replaceAll:function(a,b,c){return a.replace(new RegExp(b,"g"),c)},idToLabel:function(a,b){return k.find(b,function(b){return b.id===a}).label}};c.load=function(a,l){if(!l&&c[a])return c[a];b.get("php/"+a+".php?type=get").then(function(b){console.log("GET SUCCESS "+a+": ",b.data);
c[a]=b.data;c.$broadcast(a)},function(a){console.log("GET FAILS: ",a)})};c.Model=function(){this.list=[];this.currentPage=1};a.vm={currentPage:1,itemsPerPage:10,maxSize:10,dummy:{image:!1},nuovaFinituraTabella:{m:!1,l:!1},nuovoAbbinamento:{m:!1,l:!1,u:!1,f:[{i:!1,n:""}]},nuovoProdotto:{m:!1,l:!1,t:!1,a:"",y:1,f:0,z:[{z:"",a:""}]},nuovoProdottoSettore:{m:!1,l:!1,c:!1,h:[]},nuovaVetrina:{m:!1,l:!1,v:1,y:1},nuovoVetrinaProdotto:{c:!1,p:!1,m:!1,k:!1,l:!1,j:!1,u:!1,f:!1,y:1,q:1},nuovaEsposizione:{m:!1,
l:!1,t:!1,y:1},nuovoEsposizioneProdotto:{c:!1,p:!1,m:!1,k:!1,l:!1,j:!1,u:!1,f:!1,y:1,q:1},nuovoEsposizioneSettore:{m:!1,l:!1,c:!1,v:0,h:[]},nuovoComposto:{m:!1,l:!1,y:1},nuovoCompostoProdotto:{c:!1,p:!1,m:!1,k:!1,l:!1,j:!1,u:!1,f:!1,y:1,q:1},nuovoCompostoSettore:{m:!1,l:!1,c:!1,v:0,h:[]},nuovaNazione:{v:1},nuovaRegione:{z:!1},nuovaProvincia:{z:!1,r:!1,b:0,l:0,t:0,j:1,m:0,k:1},nuovaConvenzione:{},nuovoAgente:{r:!1},nuovoRivenditore:{z:!1,r:!1,p:!1,b:0,l:0,t:0,j:1,m:0,k:1,v:!1,c:"",h:"",f:"",a:""}};
a.filtro={show:"",categoria:{i:!1},settore:"",marchio:{i:!1,n:""},tbpr:{i:!1,n:""},finitura:{i:!1,n:"",c:""},linea:{i:!1,n:""},newLinea:{i:!1,n:""},finituraTabella:{i:!1,n:""},abbinamento:{i:!1,c:""},lineaSettore:{i:!1,n:"",c:""},prodotto:{c:""},prodottoSettore:{n:""},vetrina:{c:""},vetrinaProdotto:{c:"",p:""},esposizione:{c:""},esposizioneProdotto:{e:"",p:""},esposizioneSettore:{c:""},composto:{c:""},compostoProdotto:{c:"",p:""},compostoSettore:{c:""},nazione:{i:""},regione:{n:"",i:""},provincia:{n:""},
convenzione:{n:""},rivenditore:{n:""},agente:{r:""}};a.$watch("filtro.marchio.i",function(){a.filtro.linea.n="";a.filtro.linea.i=!1});a.errore={marchio:!1,tbpr:!1,finitura:!1,linea:!1,finituraTabella:!1,abbinamento:!1,lineaSettore:!1,prodotto:!1,prodottoSettore:!1,vetrina:!1,vetrinaProdotto:!1,esposizione:!1,esposizioneProdotto:!1,composto:!1,compostoProdotto:!1,regione:!1,provincia:!1,rivenditore:!1,agente:!1};c.saving=!1;c.changing=!1;var l=function(b){a.vm.currentSubLink=b.slice(1);a.vm.currentPage=
1;a.vm.itemsPerPage=10;a.filtro.show=""};a.vm.changeLink=function(a){d.path(a.link);l(d.path())};a.$on("$locationChangeSuccess",function(){l(d.path())});e.finitureTabelle().then(function(b){a.vm.finitureTabelle=b.data;a.vm.nuovaFinituraTabella.i=k.max(a.vm.finitureTabelle,function(a){return a.i}).i+1});e.abbinamenti().then(function(b){a.vm.abbinamenti=b.data;a.vm.nuovoAbbinamento.i=k.max(a.vm.abbinamenti,function(a){return a.i}).i+1});e.prodotti().then(function(b){a.vm.prodotti=b.data;a.vm.nuovoProdotto.i=
k.max(a.vm.prodotti,function(a){return a.i}).i+1});e.prodottiSettori().then(function(b){a.vm.prodottiSettori=b.data;a.vm.nuovoProdottoSettore.i=k.max(a.vm.prodottiSettori,function(a){return a.i}).i+1});e.vetrine().then(function(b){a.vm.vetrine=b.data;a.vm.nuovaVetrina.i=k.max(a.vm.vetrine,function(a){return a.i}).i+1});e.vetrineProdotti().then(function(b){a.vm.vetrineProdotti=b.data;a.vm.nuovoVetrinaProdotto.i=k.max(a.vm.vetrineProdotti,function(a){return a.i}).i+1});e.esposizioni().then(function(b){a.vm.esposizioni=
b.data;a.vm.nuovaEsposizione.i=k.max(a.vm.esposizioni,function(a){return a.i}).i+1});e.esposizioniProdotti().then(function(b){a.vm.esposizioniProdotti=b.data;a.vm.nuovoEsposizioneProdotto.i=k.max(a.vm.esposizioniProdotti,function(a){return a.i}).i+1});e.esposizioniSettori().then(function(b){a.vm.esposizioniSettori=b.data;a.vm.nuovoEsposizioneSettore.i=k.max(a.vm.esposizioniSettori,function(a){return a.i}).i+1});e.composti().then(function(b){a.vm.composti=b.data;a.vm.nuovoComposto.i=k.max(a.vm.composti,
function(a){return a.i}).i+1});e.compostiProdotti().then(function(b){a.vm.compostiProdotti=b.data;a.vm.nuovoCompostoProdotto.i=k.max(a.vm.compostiProdotti,function(a){return a.i}).i+1});e.compostiSettori().then(function(b){a.vm.compostiSettori=b.data;a.vm.nuovoCompostoSettore.i=k.max(a.vm.compostiSettori,function(a){return a.i}).i+1});e.nazioni().then(function(b){a.vm.nazioni=b.data;a.vm.nuovaNazione.i=0===a.vm.nazioni.length?1:k.max(a.vm.nazioni,function(a){return a.i}).i+1});e.regioni().then(function(b){a.vm.regioni=
b.data;a.vm.nuovaRegione.i=0===a.vm.regioni.length?1:k.max(a.vm.regioni,function(a){return a.i}).i+1});e.province().then(function(b){a.vm.province=b.data;a.vm.nuovaProvincia.i=0===a.vm.province.length?1:k.max(a.vm.province,function(a){return a.i}).i+1});e.convenzioni().then(function(b){a.vm.convenzioni=b.data;a.vm.nuovaConvenzione.i=0===a.vm.convenzioni.length?1:k.max(a.vm.convenzioni,function(a){return a.i}).i+1});e.agenti().then(function(b){a.vm.agenti=b.data?b.data:[];a.vm.nuovoAgente.i=0===a.vm.agenti.length?
1:k.max(a.vm.agenti,function(a){return a.i}).i+1});e.rivenditori().then(function(b){a.vm.rivenditori=b.data;a.vm.nuovoRivenditore.i=k.max(a.vm.rivenditori,function(a){return a.i}).i+1});a.sorting=function(b){a.vm.sorting=a.vm.sorting===b?"-"+b:b};a.convert=function(b,c,l){var d=[],m="";if("object"===typeof b){for(var e={i:0};e.i<b.length;e={i:e.i},e.i++)k.each(a.vm[c],function(a){return function(c){c.i===b[a.i]&&d.push(c[l])}}(e));return d}k.each(a.vm[c],function(a){a.i===b&&(m=a[l])});return m};
Number.prototype.formatMoney=function(a,b,c){var l=this,d=isNaN(a=Math.abs(a))?2:a;a=void 0===b?".":b;c=void 0===c?",":c;b=0>l?"-":"";var m=parseInt(l=Math.abs(+l||0).toFixed(d))+"",e=3<m.length?m.length%3:0;return b+(e?m.substr(0,e)+c:"")+m.substr(e).replace(/(\d{3})(?=\d)/g,"$1"+c)+(d?a+Math.abs(l-m).toFixed(d).slice(2):"")};a.convertPrice=function(a){return a.formatMoney(2,",",".")};a.convertFinType=function(a){return 0===a?"Finitura":"Rivestimento"};a.convertPriceType=function(a){switch(a){case 1:return"Best price";
case 2:return"Economico";case 3:return"Design";case 4:return"Alto design";case 5:return"Luxury"}};a.vm.links=h}angular.module("mpuDashboard").controller("categorieCtrl",categorieCtrl);categorieCtrl.$inject=["$scope","$rootScope"];
...
function finitureCtrl(a,c){a.entity=new c.Model;a.entity.finitura={show:1,tipo:0,marchio:!1,immagine:!1};a.selectItem=function(d){var k=d.fin_nome,f=d.fin_cod,e=d.fin_mark_id,g=c.settings.replaceAll(k," ","_"),h=c.settings.replaceAll(f," ","_"),b=c.settings.replaceAll(c.settings.convert(e,"marchi","mark_id","mark_nome")," ","_");a.entity.finitura={id:d.fin_id,nome:k,codice:f,marchio:e,show:d.fin_show,tipo:d.fin_type_id,immagine:"../dashboard/archivio_dati/"+b+"/Finiture/"+(g+"_"+h+".jpg")}};a.$on("updateTable",
...
function settoriLineeCtrl(a,c){a.entity=new c.Model;a.entity.settore_linea={show:1,prezzo:3,marchio:!1,linea:!1,settore:!1,immagine:!1};a.selectItem=function(d){var k=d.stln_mark_id,f=d.stln_line_id,e=d.stln_set_id,g=c.settings.replaceAll(c.settings.convert(k,"marchi","mark_id","mark_nome")," ","_"),h=c.settings.replaceAll(c.settings.convert(f,"linee","line_id","line_nome")," ","_"),b=c.settings.replaceAll(c.settings.convert(e,"settori","set_id","set_nome")," ","_");a.entity.settore_linea={id:d.stln_id,
marchio:k,linea:f,settore:e,show:d.stln_show,prezzo:d.stln_price,immagine:"../dashboard/archivio_dati/"+g+"/"+h+"/Vetrina/"+(h+"_"+b+".jpg")}};a.$on("updateTable",function(){return c.load("settori_linee",!0)});c.load("marchi");c.load("linee");c.load("settori");c.load("settori_linee")}
