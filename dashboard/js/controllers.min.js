...
function mainCtrl(a,c,d,k,f,e,g,h,b){c.options={show:[{id:1,label:"Online"},{id:0,label:"Offline"}],finitura:[{id:1,label:"Rivestimento"},{id:0,label:"Finitura"}],homepage:[{id:1,label:"Visibile"},{id:0,label:"Non visibile"}]};c.Actions=function(a,l){this.success=function(b){console.log("Risposta dalla pagina PHP",b);a.$emit("updateTable");"Updated"!==b.data&&a.actions.reset();c.saving=!1;a.confirm=!1};this.fail=function(a){console.log(a);c.saving=!1};this.confirm=function(){a.confirm=!0;g(function(){return a.confirm=
!1},4E3)};this.create=function(){c.saving=!0;var m=a.buildBody();b.post("php/"+l+".php?type=new",JSON.stringify(m)).then(this.success,this.fail)};this.update=function(){c.saving=!0;var m=a.buildBody();m.id=a.entity.id;b.post("php/"+l+".php?type=update",JSON.stringify(m)).then(this.success,this.fail)};this.erase=function(){c.saving=!0;var m=a.buildBody();m.id=a.entity.id;b.post("php/"+l+".php?type=delete",JSON.stringify(m)).then(this.success,this.fail)}};c.settings={itemsPerPage:5,query:{},tooltip:"top",
show:function(a,b){return a>=(b-1)*c.settings.itemsPerPage&&a<b*c.settings.itemsPerPage},convert:function(a,b,l,d){if(c[b])return k.find(c[b],function(b){return parseInt(b[l])===parseInt(a)})[d]},parse:function(a){return JSON.parse(a)},generateObject:function(a,b,l){var m=[];k.each(c[a],function(a){var c=parseInt(a[b+"_id"]);m.push({id:c,nome:a[b+"_nome"],checked:l?-1!==l.indexOf(c):!1})});return m},replaceAll:function(a,b,l){return a.replace(new RegExp(b,"g"),l)}};c.load=function(a,l){if(!l&&c[a])return c[a];
b.get("php/"+a+".php?type=get").then(function(b){console.log("GET "+a+": risposta dalla pagina PHP",b.data);c[a]=b.data;c.$broadcast(a)},function(a){console.log(a)})};c.Model=function(){this.list=[];this.currentPage=1};a.vm={currentPage:1,itemsPerPage:10,maxSize:10,dummy:{image:!1},nuovaLinea:{a:[!1],q:[],v:1,z:2,b:0,y:100,c:0,s:0,e:25,w:2,g:!1,r:!1,k:!1,j:!1},nuovaFinituraTabella:{m:!1,l:!1},nuovoAbbinamento:{m:!1,l:!1,u:!1,f:[{i:!1,n:""}]},nuovoProdotto:{m:!1,l:!1,t:!1,a:"",y:1,f:0,z:[{z:"",a:""}]},
nuovaLineaSettore:{v:1,p:0,z:2,q:[],m:!1,r:!1},nuovoProdottoSettore:{m:!1,l:!1,c:!1,h:[]},nuovaVetrina:{m:!1,l:!1,v:1,y:1},nuovoVetrinaProdotto:{c:!1,p:!1,m:!1,k:!1,l:!1,j:!1,u:!1,f:!1,y:1,q:1},nuovaEsposizione:{m:!1,l:!1,t:!1,y:1},nuovoEsposizioneProdotto:{c:!1,p:!1,m:!1,k:!1,l:!1,j:!1,u:!1,f:!1,y:1,q:1},nuovoEsposizioneSettore:{m:!1,l:!1,c:!1,v:0,h:[]},nuovoComposto:{m:!1,l:!1,y:1},nuovoCompostoProdotto:{c:!1,p:!1,m:!1,k:!1,l:!1,j:!1,u:!1,f:!1,y:1,q:1},nuovoCompostoSettore:{m:!1,l:!1,c:!1,v:0,h:[]},
nuovaNazione:{v:1},nuovaRegione:{z:!1},nuovaProvincia:{z:!1,r:!1,b:0,l:0,t:0,j:1,m:0,k:1},nuovaConvenzione:{},nuovoAgente:{r:!1},nuovoRivenditore:{z:!1,r:!1,p:!1,b:0,l:0,t:0,j:1,m:0,k:1,v:!1,c:"",h:"",f:"",a:""}};a.filtro={show:"",categoria:{i:!1},settore:"",marchio:{i:!1,n:""},tbpr:{i:!1,n:""},finitura:{i:!1,n:"",c:""},linea:{i:!1,n:""},newLinea:{i:!1,n:""},finituraTabella:{i:!1,n:""},abbinamento:{i:!1,c:""},lineaSettore:{i:!1,n:"",c:""},prodotto:{c:""},prodottoSettore:{n:""},vetrina:{c:""},vetrinaProdotto:{c:"",
p:""},esposizione:{c:""},esposizioneProdotto:{e:"",p:""},esposizioneSettore:{c:""},composto:{c:""},compostoProdotto:{c:"",p:""},compostoSettore:{c:""},nazione:{i:""},regione:{n:"",i:""},provincia:{n:""},convenzione:{n:""},rivenditore:{n:""},agente:{r:""}};a.$watch("filtro.marchio.i",function(){a.filtro.linea.n="";a.filtro.linea.i=!1});a.errore={marchio:!1,tbpr:!1,finitura:!1,linea:!1,finituraTabella:!1,abbinamento:!1,lineaSettore:!1,prodotto:!1,prodottoSettore:!1,vetrina:!1,vetrinaProdotto:!1,esposizione:!1,
...
function(a){return a.i}).i+1});e.linee().then(function(b){a.vm.linee=b.data;a.vm.nuovaLinea.i=k.max(a.vm.linee,function(a){return a.i}).i+1});e.vetrine().then(function(b){a.vm.vetrine=b.data;a.vm.nuovaVetrina.i=k.max(a.vm.vetrine,function(a){return a.i}).i+1});e.vetrineProdotti().then(function(b){a.vm.vetrineProdotti=b.data;a.vm.nuovoVetrinaProdotto.i=k.max(a.vm.vetrineProdotti,function(a){return a.i}).i+1});e.esposizioni().then(function(b){a.vm.esposizioni=b.data;a.vm.nuovaEsposizione.i=k.max(a.vm.esposizioni,
function(a){return a.i}).i+1});e.esposizioniProdotti().then(function(b){a.vm.esposizioniProdotti=b.data;a.vm.nuovoEsposizioneProdotto.i=k.max(a.vm.esposizioniProdotti,function(a){return a.i}).i+1});e.esposizioniSettori().then(function(b){a.vm.esposizioniSettori=b.data;a.vm.nuovoEsposizioneSettore.i=k.max(a.vm.esposizioniSettori,function(a){return a.i}).i+1});e.composti().then(function(b){a.vm.composti=b.data;a.vm.nuovoComposto.i=k.max(a.vm.composti,function(a){return a.i}).i+1});e.compostiProdotti().then(function(b){a.vm.compostiProdotti=
b.data;a.vm.nuovoCompostoProdotto.i=k.max(a.vm.compostiProdotti,function(a){return a.i}).i+1});e.compostiSettori().then(function(b){a.vm.compostiSettori=b.data;a.vm.nuovoCompostoSettore.i=k.max(a.vm.compostiSettori,function(a){return a.i}).i+1});e.nazioni().then(function(b){a.vm.nazioni=b.data;a.vm.nuovaNazione.i=0===a.vm.nazioni.length?1:k.max(a.vm.nazioni,function(a){return a.i}).i+1});e.regioni().then(function(b){a.vm.regioni=b.data;a.vm.nuovaRegione.i=0===a.vm.regioni.length?1:k.max(a.vm.regioni,
function(a){return a.i}).i+1});e.province().then(function(b){a.vm.province=b.data;a.vm.nuovaProvincia.i=0===a.vm.province.length?1:k.max(a.vm.province,function(a){return a.i}).i+1});e.convenzioni().then(function(b){a.vm.convenzioni=b.data;a.vm.nuovaConvenzione.i=0===a.vm.convenzioni.length?1:k.max(a.vm.convenzioni,function(a){return a.i}).i+1});e.agenti().then(function(b){a.vm.agenti=b.data?b.data:[];a.vm.nuovoAgente.i=0===a.vm.agenti.length?1:k.max(a.vm.agenti,function(a){return a.i}).i+1});e.rivenditori().then(function(b){a.vm.rivenditori=
b.data;a.vm.nuovoRivenditore.i=k.max(a.vm.rivenditori,function(a){return a.i}).i+1});a.sorting=function(b){a.vm.sorting=a.vm.sorting===b?"-"+b:b};a.convert=function(b,l,c){var m=[],d="";if("object"===typeof b){for(var e={i:0};e.i<b.length;e={i:e.i},e.i++)k.each(a.vm[l],function(a){return function(l){l.i===b[a.i]&&m.push(l[c])}}(e));return m}k.each(a.vm[l],function(a){a.i===b&&(d=a[c])});return d};Number.prototype.formatMoney=function(a,b,l){var c=this,d=isNaN(a=Math.abs(a))?2:a;a=void 0===b?".":b;
l=void 0===l?",":l;b=0>c?"-":"";var m=parseInt(c=Math.abs(+c||0).toFixed(d))+"",e=3<m.length?m.length%3:0;return b+(e?m.substr(0,e)+l:"")+m.substr(e).replace(/(\d{3})(?=\d)/g,"$1"+l)+(d?a+Math.abs(c-m).toFixed(d).slice(2):"")};a.convertPrice=function(a){return a.formatMoney(2,",",".")};a.convertFinType=function(a){return 0===a?"Finitura":"Rivestimento"};a.convertPriceType=function(a){switch(a){case 1:return"Best price";case 2:return"Economico";case 3:return"Design";case 4:return"Alto design";case 5:return"Luxury"}};
a.vm.links=h}angular.module("mpuDashboard").controller("categorieCtrl",categorieCtrl);categorieCtrl.$inject=["$scope","$rootScope"];
...
function finitureCtrl(a,c){a.entity=new c.Model;a.entity.finitura={show:1,tipo:0,posizione:0,marchio:!1,immagine:!1};a.selectItem=function(d){var k=d.fin_nome,f=d.fin_cod,e=d.fin_mark_id,g=c.settings.replaceAll(k," ","_"),h=c.settings.replaceAll(f," ","_"),b=c.settings.replaceAll(c.settings.convert(e,"marchi","mark_id","mark_nome")," ","_");g=g+"_"+h+".jpg";a.entity.finitura={id:parseInt(d.fin_id),nome:k,codice:f,marchio:e,show:parseInt(d.fin_show),tipo:parseInt(d.fin_type_id),immagine:"../dashboard/archivio_dati/"+
b+"/Finiture/"+g}};a.$on("updateTable",function(){return c.load("finiture",!0)});c.load("marchi");c.load("finiture")}
angular.module("mpuDashboard").controller("lineeCtrl",["$scope","$rootScope","_","dataSvc","$http","$timeout","lineeManager",function(a,c,d,k,f,e,g){a.linea={selected:!1};a.vm.sorting=["m","n","y"];a.vm.lineeManager=g;a.selectLinea=function(b){a.linea={};a.linea.selected=!0;a.linea.linea=b};a.vm.saveLineaData=function(){c.saving=!0;f.post("php/linee.php?type=save",a.vm.linee).success(function(){c.saving=!1}).error(function(a,b){console.log(b)})};a.saveDataDB=function(){c.saving=!0;f.post("php/linee.php?type=db").success(function(){c.saving=
!1;k.linee().then(function(b){a.vm.linee=b.data})}).error(function(a,b){console.log(b)})};a.saveDataDB();var h="",b;a.$watch("input",function(l){b&&e.cancel(b);h=l;b=e(function(){a.filtro.linea.n=h},250)});a.eraseInput=function(b){27===b.key&&(a.input="")};a.addLink=function(){a.vm.nuovaLinea.a.push(!1)};a.removeLink=function(b){1===a.vm.nuovaLinea.a.length?a.vm.nuovaLinea.a=[!1]:a.vm.nuovaLinea.splice(b,1)};a.toggleSet=function(b){-1===a.vm.nuovaLinea.q.indexOf(b)?a.vm.nuovaLinea.q.push(parseInt(b)):
...
a.saveDataDB=function(){c.saving=!0;f.post("php/finitureTabelle.php?type=db").success(function(b){c.saving=!1;k.finitureTabelle().then(function(b){a.vm.finitureTabelle=b.data})}).error(function(a,l){console.log(l)})};var g="",h;a.$watch("input",function(b){h&&e.cancel(h);g=b;h=e(function(){a.filtro.finituraTabella.n=g},250)});a.eraseInput=function(b){27===b.key&&(a.input="")};a.newFinituraTabella=function(){c.saving=!1;a.errore.finituraTabella=!1;a.vm.nuovaFinituraTabella={i:a.vm.nuovaFinituraTabella.i+
