...
function mainCtrl(a,c,d,h,f,e,g,k,b){c.options={show:[{id:1,label:"Online"},{id:0,label:"Offline"}],finitura:[{id:1,label:"Rivestimento"},{id:0,label:"Finitura"}],homepage:[{id:1,label:"Visibile"},{id:0,label:"Non visibile"}],vetrina:[{id:1,label:"Attivata"},{id:0,label:"Disattivata"}],prezzo:[{id:1,label:"Bassa"},{id:2,label:"Media/Bassa"},{id:3,label:"Media"},{id:4,label:"Media/Alta"},{id:5,label:"Alta"}]};c.Actions=function(a,l){this.success=function(b){console.log("SUCCESS: ",b);a.$emit("updateTable");
"Updated"!==b.data&&a.actions.reset();c.saving=!1;a.confirm=!1};this.fail=function(a){console.log("FAIL: ",a);c.saving=!1};this.confirm=function(){a.confirm=!0;g(function(){return a.confirm=!1},4E3)};this.create=function(){c.saving=!0;var m=a.buildBody();b.post("php/"+l+".php?type=new",JSON.stringify(m)).then(this.success,this.fail)};this.update=function(){c.saving=!0;var m=a.buildBody();m.id=a.entity.id;b.post("php/"+l+".php?type=update",JSON.stringify(m)).then(this.success,this.fail)};this.erase=
function(){c.saving=!0;var m=a.buildBody();m.id=a.entity.id;b.post("php/"+l+".php?type=delete",JSON.stringify(m)).then(this.success,this.fail)};this.cleanInputFile=function(){angular.forEach(angular.element("input[type='file']"),function(a){angular.element(a).val(null)})}};c.settings={itemsPerPage:5,query:{},tooltip:"top",show:function(a,b){return a>=(b-1)*c.settings.itemsPerPage&&a<b*c.settings.itemsPerPage},convert:function(a,b,l,d){if(c[b])return h.find(c[b],function(b){return parseInt(b[l])===
parseInt(a)})[d]},parse:function(a){return JSON.parse(a)},generateObject:function(a,b,l){var m=[];h.each(c[a],function(a){var c=parseInt(a[b+"_id"]);m.push({id:c,nome:a[b+"_nome"],checked:l?-1!==l.indexOf(c):!1})});return m},replaceAll:function(a,b,c){return a.replace(new RegExp(b,"g"),c)},idToLabel:function(a,b){return h.find(b,function(b){return b.id===a}).label}};c.load=function(a,l){if(!l&&c[a])return c[a];b.get("php/"+a+".php?type=get").then(function(b){console.log("GET SUCCESS "+a+": ",b.data);
...
function(a){return a.i}).i+1});e.agenti().then(function(b){a.vm.agenti=b.data?b.data:[];a.vm.nuovoAgente.i=0===a.vm.agenti.length?1:h.max(a.vm.agenti,function(a){return a.i}).i+1});e.rivenditori().then(function(b){a.vm.rivenditori=b.data;a.vm.nuovoRivenditore.i=h.max(a.vm.rivenditori,function(a){return a.i}).i+1});a.sorting=function(b){a.vm.sorting=a.vm.sorting===b?"-"+b:b};a.convert=function(b,c,l){var d=[],m="";if("object"===typeof b){for(var e={i:0};e.i<b.length;e={i:e.i},e.i++)h.each(a.vm[c],
function(a){return function(c){c.i===b[a.i]&&d.push(c[l])}}(e));return d}h.each(a.vm[c],function(a){a.i===b&&(m=a[l])});return m};Number.prototype.formatMoney=function(a,b,c){var l=this,d=isNaN(a=Math.abs(a))?2:a;a=void 0===b?".":b;c=void 0===c?",":c;b=0>l?"-":"";var m=parseInt(l=Math.abs(+l||0).toFixed(d))+"",e=3<m.length?m.length%3:0;return b+(e?m.substr(0,e)+c:"")+m.substr(e).replace(/(\d{3})(?=\d)/g,"$1"+c)+(d?a+Math.abs(l-m).toFixed(d).slice(2):"")};a.convertPrice=function(a){return a.formatMoney(2,
...
!a.vm.nuovoRivenditore.c||!a.vm.nuovoRivenditore.e||!a.vm.nuovoRivenditore.w||!a.vm.nuovoRivenditore.g};a.newItem=function(){c.saving=!1;a.errore.rivenditore=!1;a.vm.nuovoRivenditore={i:a.vm.nuovoRivenditore.i+1,z:!1,r:!1,p:!1,b:0,l:0,t:0,j:1,m:0,k:1,v:!1,c:"",h:"",f:"",a:""};k()};var m=[];a.showInfoFnc=function(a,b){"add"===b?m.push(a):(a=m.indexOf(a),m.splice(a,1))};a.checkShowInfo=function(a){return m.indexOf(a)};a.action=function(b){"N"===b&&(b=a.vm.nuovoRivenditore.p?d.findWhere(a.vm.rivenditori,
