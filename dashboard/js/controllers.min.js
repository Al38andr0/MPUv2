...
l:!1},nuovoAbbinamento:{m:!1,l:!1,u:!1,f:[{i:!1,n:""}]},nuovoProdotto:{m:!1,l:!1,t:!1,a:"",y:1,f:0,z:[{z:"",a:""}]},nuovaLineaSettore:{v:1,p:0,z:2,q:[],m:!1,r:!1},nuovoProdottoSettore:{m:!1,l:!1,c:!1,h:[]},nuovaVetrina:{m:!1,l:!1,v:1,y:1},nuovoVetrinaProdotto:{c:!1,p:!1,m:!1,k:!1,l:!1,j:!1,u:!1,f:!1,y:1,q:1},nuovaEsposizione:{m:!1,l:!1,t:!1,y:1},nuovoEsposizioneProdotto:{c:!1,p:!1,m:!1,k:!1,l:!1,j:!1,u:!1,f:!1,y:1,q:1},nuovoEsposizioneSettore:{m:!1,l:!1,c:!1,v:0,h:[]},nuovoComposto:{m:!1,l:!1,y:1},
...
angular.module("mpuDashboard").controller("lineeCtrl",["$scope","$rootScope","_","dataSvc","$http","$timeout","lineeManager",function(a,c,f,k,e,d,h){a.linea={selected:!1};a.vm.sorting=["m","n","y"];a.vm.lineeManager=h;a.selectLinea=function(b){a.linea={};a.linea.selected=!0;a.linea.linea=b};a.vm.saveLineaData=function(){c.saving=!0;e.post("php/linee.php?type=save",a.vm.linee).success(function(){c.saving=!1}).error(function(a,b){console.log(b)})};a.saveDataDB=function(){c.saving=!0;e.post("php/linee.php?type=db").success(function(){c.saving=
!1;k.linee().then(function(b){a.vm.linee=b.data})}).error(function(a,b){console.log(b)})};a.saveDataDB();var g="",b;a.$watch("input",function(l){b&&d.cancel(b);g=l;b=d(function(){a.filtro.linea.n=g},250)});a.eraseInput=function(b){27==b.keyCode&&(a.input="")};a.addLink=function(){a.vm.nuovaLinea.a.push(!1)};a.removeLink=function(b){1==a.vm.nuovaLinea.a.length?a.vm.nuovaLinea.a=[!1]:a.vm.nuovaLinea.splice(b,1)};a.toggleSet=function(b){-1==a.vm.nuovaLinea.q.indexOf(b)?a.vm.nuovaLinea.q.push(parseInt(b)):
a.vm.nuovaLinea.q.splice(a.vm.nuovaLinea.q.indexOf(b),1)};a.updateCheck=function(){return!a.vm.nuovaLinea.n||isNaN(a.vm.nuovaLinea.e)||isNaN(a.vm.nuovaLinea.w)||isNaN(a.vm.nuovaLinea.s)||!a.vm.nuovaLinea.m};a.newLinea=function(){c.saving=!1;a.errore.linea=!1;a.vm.nuovaLinea={i:a.vm.nuovaLinea.i+1,q:[],a:[!1],v:1,z:2,b:0,y:100,c:0,s:0,e:25,w:2,g:!1,r:!1,k:!1,j:!1}};a.action=function(b){"N"==b&&(f.findWhere(a.vm.linee,{nome:a.vm.nuovaLinea.n,mark:a.vm.nuovaLinea.m})?a.errore.linea=!0:(c.saving=!0,e.post("php/linee.php?type=new",
{id:a.vm.nuovaLinea.i,nome:a.vm.nuovaLinea.n,mark:a.vm.nuovaLinea.m,disc:a.vm.nuovaLinea.s,time:a.vm.nuovaLinea.e,war:a.vm.nuovaLinea.w,ctl:a.vm.nuovaLinea.k,spc:a.vm.nuovaLinea.j,image:a.vm.nuovaLinea.r,show:a.vm.nuovaLinea.v,price:a.vm.nuovaLinea.z,cat:a.vm.nuovaLinea.g,set:a.vm.nuovaLinea.q,link:a.vm.nuovaLinea.a,vtr:a.vm.nuovaLinea.c,pos:a.vm.nuovaLinea.y}).success(function(b){console.log("Risposta dalla pagina PHP",b);a.vm.nuovaLinea.k=a.vm.nuovaLinea.k?1:!1;a.vm.nuovaLinea.j=a.vm.nuovaLinea.j?
1:!1;a.vm.linee.push(a.vm.nuovaLinea);a.vm.saveLineaData();a.newLinea()}).error(function(a,b){console.log(b)})))}}]);
...
angular.module("mpuDashboard").controller("lineeSettoriCtrl",["$scope","$rootScope","_","dataSvc","$http","$timeout","lineeManager",function(a,c,f,k,e,d,h){a.lineaSettore={selected:!1};a.priceName=[{n:"basso",i:1},{n:"medio/basso",i:2},{n:"medio",i:3},{n:"medio/alto",i:4},{n:"alto",i:5}];a.vm.lineeManager=h;a.vm.sorting=["m"];a.selectLineaSettore=function(b){a.lineaSettore={};a.lineaSettore.selected=!0;a.lineaSettore.lineaSettore=b};a.vm.saveLineaSettoreData=function(){c.saving=!0;e.post("php/lineeSettori.php?type=save",
a.vm.lineeSettori).success(function(){c.saving=!1}).error(function(a,b){console.log(b)})};a.saveDataDB=function(){c.saving=!0;e.post("php/lineeSettori.php?type=db").success(function(){c.saving=!1;k.lineeSettori().then(function(b){a.vm.lineeSettori=b.data})}).error(function(a,b){console.log(b)})};a.saveDataDB();var g="",b;a.$watch("input",function(l){b&&d.cancel(b);g=l;b=d(function(){a.filtro.lineaSettore.n=g},250)});a.$watch("inputCod",function(l){b&&d.cancel(b);g=l;b=d(function(){a.filtro.lineaSettore.c=
