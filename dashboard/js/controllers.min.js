...
function mainCtrl(a,c,d,k,f,e,h,g,b){c.options={show:[{id:1,label:"Online"},{id:0,label:"Offline"}],homepage:[{id:1,label:"Visibile"},{id:0,label:"Non visibile"}]};c.Actions=function(a,l){this.success=function(b){console.log("Risposta dalla pagina PHP",b);a.$emit("updateTable");"Updated"!==b.data&&a.actions.reset();c.saving=!1;a.confirm=!1};this.fail=function(a){console.log(a);c.saving=!1};this.confirm=function(){a.confirm=!0;h(function(){return a.confirm=!1},4E3)};this.create=function(){c.saving=
!0;var m=a.buildBody();b.post("php/"+l+".php?type=new",JSON.stringify(m)).then(this.success,this.fail)};this.update=function(){c.saving=!0;var m=a.buildBody();m.id=a.entity.id;b.post("php/"+l+".php?type=update",JSON.stringify(m)).then(this.success,this.fail)};this.erase=function(){c.saving=!0;var m=a.buildBody();m.id=a.entity.id;b.post("php/"+l+".php?type=delete",JSON.stringify(m)).then(this.success,this.fail)}};c.settings={itemsPerPage:5,query:{},tooltip:"top",show:function(a,b){return a>=(b-1)*
c.settings.itemsPerPage&&a<b*c.settings.itemsPerPage},convert:function(a,b,l,d){if(c[b])return k.find(c[b],function(b){return parseInt(b[l])===a})[d]},parse:function(a){return JSON.parse(a)},generateObject:function(a,b,l){var m=[];k.each(c[a],function(a){var c=parseInt(a[b+"_id"]);m.push({id:c,nome:a[b+"_nome"],checked:l?-1!==l.indexOf(c):!1})});return m}};c.load=function(a,l){if(!l&&c[a])return c[a];b.get("php/"+a+".php?type=get").then(function(b){console.log("GET "+a+": risposta dalla pagina PHP",
b.data);c[a]=b.data;c.$broadcast(a)},function(a){console.log(a)})};c.Model=function(){this.list=[];this.currentPage=1};a.vm={currentPage:1,itemsPerPage:10,maxSize:10,dummy:{image:!1},nuovaLinea:{a:[!1],q:[],v:1,z:2,b:0,y:100,c:0,s:0,e:25,w:2,g:!1,r:!1,k:!1,j:!1},nuovaFinituraTabella:{m:!1,l:!1},nuovoAbbinamento:{m:!1,l:!1,u:!1,f:[{i:!1,n:""}]},nuovoProdotto:{m:!1,l:!1,t:!1,a:"",y:1,f:0,z:[{z:"",a:""}]},nuovaLineaSettore:{v:1,p:0,z:2,q:[],m:!1,r:!1},nuovoProdottoSettore:{m:!1,l:!1,c:!1,h:[]},nuovaVetrina:{m:!1,
l:!1,v:1,y:1},nuovoVetrinaProdotto:{c:!1,p:!1,m:!1,k:!1,l:!1,j:!1,u:!1,f:!1,y:1,q:1},nuovaEsposizione:{m:!1,l:!1,t:!1,y:1},nuovoEsposizioneProdotto:{c:!1,p:!1,m:!1,k:!1,l:!1,j:!1,u:!1,f:!1,y:1,q:1},nuovoEsposizioneSettore:{m:!1,l:!1,c:!1,v:0,h:[]},nuovoComposto:{m:!1,l:!1,y:1},nuovoCompostoProdotto:{c:!1,p:!1,m:!1,k:!1,l:!1,j:!1,u:!1,f:!1,y:1,q:1},nuovoCompostoSettore:{m:!1,l:!1,c:!1,v:0,h:[]},nuovaNazione:{v:1},nuovaRegione:{z:!1},nuovaProvincia:{z:!1,r:!1,b:0,l:0,t:0,j:1,m:0,k:1},nuovaConvenzione:{},
nuovoAgente:{r:!1},nuovoRivenditore:{z:!1,r:!1,p:!1,b:0,l:0,t:0,j:1,m:0,k:1,v:!1,c:"",h:"",f:"",a:""}};a.filtro={show:"",categoria:{i:!1},settore:"",marchio:{i:!1,n:""},tbpr:{i:!1,n:""},finitura:{i:!1,n:"",c:""},linea:{i:!1,n:""},newLinea:{i:!1,n:""},finituraTabella:{i:!1,n:""},abbinamento:{i:!1,c:""},lineaSettore:{i:!1,n:"",c:""},prodotto:{c:""},prodottoSettore:{n:""},vetrina:{c:""},vetrinaProdotto:{c:"",p:""},esposizione:{c:""},esposizioneProdotto:{e:"",p:""},esposizioneSettore:{c:""},composto:{c:""},
compostoProdotto:{c:"",p:""},compostoSettore:{c:""},nazione:{i:""},regione:{n:"",i:""},provincia:{n:""},convenzione:{n:""},rivenditore:{n:""},agente:{r:""}};a.$watch("filtro.marchio.i",function(){a.filtro.linea.n="";a.filtro.linea.i=!1});a.errore={marchio:!1,tbpr:!1,finitura:!1,linea:!1,finituraTabella:!1,abbinamento:!1,lineaSettore:!1,prodotto:!1,prodottoSettore:!1,vetrina:!1,vetrinaProdotto:!1,esposizione:!1,esposizioneProdotto:!1,composto:!1,compostoProdotto:!1,regione:!1,provincia:!1,rivenditore:!1,
agente:!1};c.saving=!1;c.changing=!1;var l=function(b){a.vm.currentSubLink=b.slice(1);a.vm.currentPage=1;a.vm.itemsPerPage=10;a.filtro.show=""};a.vm.changeLink=function(a){d.path(a.link);l(d.path())};a.$on("$locationChangeSuccess",function(){l(d.path())});e.finitureTabelle().then(function(b){a.vm.finitureTabelle=b.data;a.vm.nuovaFinituraTabella.i=k.max(a.vm.finitureTabelle,function(a){return a.i}).i+1});e.abbinamenti().then(function(b){a.vm.abbinamenti=b.data;a.vm.nuovoAbbinamento.i=k.max(a.vm.abbinamenti,
function(a){return a.i}).i+1});e.prodotti().then(function(b){a.vm.prodotti=b.data;a.vm.nuovoProdotto.i=k.max(a.vm.prodotti,function(a){return a.i}).i+1});e.lineeSettori().then(function(b){a.vm.lineeSettori=b.data;a.vm.nuovaLineaSettore.i=k.max(a.vm.lineeSettori,function(a){return a.i}).i+1});e.prodottiSettori().then(function(b){a.vm.prodottiSettori=b.data;a.vm.nuovoProdottoSettore.i=k.max(a.vm.prodottiSettori,function(a){return a.i}).i+1});e.linee().then(function(b){a.vm.linee=b.data;a.vm.nuovaLinea.i=
k.max(a.vm.linee,function(a){return a.i}).i+1});e.vetrine().then(function(b){a.vm.vetrine=b.data;a.vm.nuovaVetrina.i=k.max(a.vm.vetrine,function(a){return a.i}).i+1});e.vetrineProdotti().then(function(b){a.vm.vetrineProdotti=b.data;a.vm.nuovoVetrinaProdotto.i=k.max(a.vm.vetrineProdotti,function(a){return a.i}).i+1});e.esposizioni().then(function(b){a.vm.esposizioni=b.data;a.vm.nuovaEsposizione.i=k.max(a.vm.esposizioni,function(a){return a.i}).i+1});e.esposizioniProdotti().then(function(b){a.vm.esposizioniProdotti=
...
k.max(a.vm.rivenditori,function(a){return a.i}).i+1});a.sorting=function(b){a.vm.sorting=a.vm.sorting===b?"-"+b:b};a.convert=function(b,l,c){var m=[],d="";if("object"===typeof b){for(var e={i:0};e.i<b.length;e={i:e.i},e.i++)k.each(a.vm[l],function(a){return function(l){l.i===b[a.i]&&m.push(l[c])}}(e));return m}k.each(a.vm[l],function(a){a.i===b&&(d=a[c])});return d};Number.prototype.formatMoney=function(a,b,l){var c=this,d=isNaN(a=Math.abs(a))?2:a;a=void 0===b?".":b;l=void 0===l?",":l;b=0>c?"-":"";
var m=parseInt(c=Math.abs(+c||0).toFixed(d))+"",e=3<m.length?m.length%3:0;return b+(e?m.substr(0,e)+l:"")+m.substr(e).replace(/(\d{3})(?=\d)/g,"$1"+l)+(d?a+Math.abs(c-m).toFixed(d).slice(2):"")};a.convertPrice=function(a){return a.formatMoney(2,",",".")};a.convertFinType=function(a){return 0===a?"Finitura":"Rivestimento"};a.convertPriceType=function(a){switch(a){case 1:return"Best price";case 2:return"Economico";case 3:return"Design";case 4:return"Alto design";case 5:return"Luxury"}};a.vm.links=g}
...
function finitureCtrl(a,c){a.entity=new c.Model;a.entity.finitura={show:1,tipo:0,posizione:0,marchio:!1,immagine:!1};a.selectItem=function(c){a.entity.finitura={id:parseInt(c.fin_id),nome:c.fin_nome,codice:c.fin_codice,marchio:c.fin_mark_id,show:parseInt(c.fin_show),tipo:parseInt(c.fin_type)}};a.$on("updateTable",function(){return c.load("finiture",!0)});c.load("marchi");c.load("finiture")}
angular.module("mpuDashboard").controller("lineeCtrl",["$scope","$rootScope","_","dataSvc","$http","$timeout","lineeManager",function(a,c,d,k,f,e,h){a.linea={selected:!1};a.vm.sorting=["m","n","y"];a.vm.lineeManager=h;a.selectLinea=function(b){a.linea={};a.linea.selected=!0;a.linea.linea=b};a.vm.saveLineaData=function(){c.saving=!0;f.post("php/linee.php?type=save",a.vm.linee).success(function(){c.saving=!1}).error(function(a,b){console.log(b)})};a.saveDataDB=function(){c.saving=!0;f.post("php/linee.php?type=db").success(function(){c.saving=
!1;k.linee().then(function(b){a.vm.linee=b.data})}).error(function(a,b){console.log(b)})};a.saveDataDB();var g="",b;a.$watch("input",function(l){b&&e.cancel(b);g=l;b=e(function(){a.filtro.linea.n=g},250)});a.eraseInput=function(b){27===b.key&&(a.input="")};a.addLink=function(){a.vm.nuovaLinea.a.push(!1)};a.removeLink=function(b){1===a.vm.nuovaLinea.a.length?a.vm.nuovaLinea.a=[!1]:a.vm.nuovaLinea.splice(b,1)};a.toggleSet=function(b){-1===a.vm.nuovaLinea.q.indexOf(b)?a.vm.nuovaLinea.q.push(parseInt(b)):
a.vm.nuovaLinea.q.splice(a.vm.nuovaLinea.q.indexOf(b),1)};a.updateCheck=function(){return!a.vm.nuovaLinea.n||isNaN(a.vm.nuovaLinea.e)||isNaN(a.vm.nuovaLinea.w)||isNaN(a.vm.nuovaLinea.s)||!a.vm.nuovaLinea.m};a.newLinea=function(){c.saving=!1;a.errore.linea=!1;a.vm.nuovaLinea={i:a.vm.nuovaLinea.i+1,q:[],a:[!1],v:1,z:2,b:0,y:100,c:0,s:0,e:25,w:2,g:!1,r:!1,k:!1,j:!1}};a.action=function(b){"N"===b&&(d.findWhere(a.vm.linee,{nome:a.vm.nuovaLinea.n,mark:a.vm.nuovaLinea.m})?a.errore.linea=!0:(c.saving=!0,
f.post("php/linee.php?type=new",{id:a.vm.nuovaLinea.i,nome:a.vm.nuovaLinea.n,mark:a.vm.nuovaLinea.m,disc:a.vm.nuovaLinea.s,time:a.vm.nuovaLinea.e,war:a.vm.nuovaLinea.w,ctl:a.vm.nuovaLinea.k,spc:a.vm.nuovaLinea.j,image:a.vm.nuovaLinea.r,show:a.vm.nuovaLinea.v,price:a.vm.nuovaLinea.z,cat:a.vm.nuovaLinea.g,set:a.vm.nuovaLinea.q,link:a.vm.nuovaLinea.a,vtr:a.vm.nuovaLinea.c,pos:a.vm.nuovaLinea.y}).success(function(b){console.log("Risposta dalla pagina PHP",b);a.vm.nuovaLinea.k=a.vm.nuovaLinea.k?1:!1;a.vm.nuovaLinea.j=
a.vm.nuovaLinea.j?1:!1;a.vm.linee.push(a.vm.nuovaLinea);a.vm.saveLineaData();a.newLinea()}).error(function(a,b){console.log(b)})))}}]);
...
a.saveDataDB=function(){c.saving=!0;f.post("php/finitureTabelle.php?type=db").success(function(b){c.saving=!1;k.finitureTabelle().then(function(b){a.vm.finitureTabelle=b.data})}).error(function(a,l){console.log(l)})};var h="",g;a.$watch("input",function(b){g&&e.cancel(g);h=b;g=e(function(){a.filtro.finituraTabella.n=h},250)});a.eraseInput=function(b){27===b.key&&(a.input="")};a.newFinituraTabella=function(){c.saving=!1;a.errore.finituraTabella=!1;a.vm.nuovaFinituraTabella={i:a.vm.nuovaFinituraTabella.i+
...
angular.module("mpuDashboard").controller("abbinamentiCtrl",["$scope","$rootScope","_","dataSvc","$http","$timeout",function(a,c,d,k,f,e){function h(){return d.filter(a.vm.nuovoAbbinamento.f,function(a){return!a.i||!a.n}).length}a.abbinamento={selected:!1};a.vm.sorting=["m","l","c"];a.$watch("vm.nuovoAbbinamento.m",function(){a.vm.nuovoAbbinamento.l=!1;a.vm.nuovoAbbinamento.u=!1;a.vm.nuovoAbbinamento.f=[{i:!1,n:""}]});a.$watch("vm.nuovoAbbinamento.l",function(){a.vm.nuovoAbbinamento.u=!1;a.vm.nuovoAbbinamento.f=
...
!1;k.prodotti().then(function(b){a.vm.prodotti=b.data})}).error(function(a,b){console.log(b)})};var h="",g;a.$watch("input",function(b){g&&e.cancel(g);h=b;g=e(function(){a.filtro.prodotto.c=h},250)});a.eraseInput=function(b){27===b.key&&(a.input="")};a.updateCheck=function(){return!a.vm.nuovoProdotto.c||!a.vm.nuovoProdotto.n||!a.vm.nuovoProdotto.m||!a.vm.nuovoProdotto.l||!a.vm.nuovoProdotto.x||!a.vm.nuovoProdotto.t||!a.vm.nuovoProdotto.r};var b=function(){return d.filter(a.vm.nuovoProdotto.z,function(a){return isNaN(a.z)||
...
!1;k.prodottiSettori().then(function(b){a.vm.prodottiSettori=b.data})}).error(function(a,c){console.log(c)})};var h="",g;a.$watch("input",function(b){g&&e.cancel(g);h=b;g=e(function(){a.filtro.prodottoSettore.n=h},250)});a.eraseInput=function(b){27===b.key&&(a.input="")};a.newProdottoSettore=function(b){c.saving=!1;a.errore.prodottoSettore=!1;a.vm.nuovoProdottoSettore={m:!1,l:!1,c:!1,h:[]};a.vm.nuovoProdottoSettore.i=b?parseInt(b)+1:a.vm.nuovoProdottoSettore.i+1;console.log(a.vm.nuovoProdottoSettore.i)};
...
a.saveDataDB=function(){c.saving=!0;f.post("php/vetrine.php?type=db").success(function(){c.saving=!1;k.vetrine().then(function(b){a.vm.vetrine=b.data})}).error(function(a,c){console.log(c)})};var h="",g;a.$watch("input",function(b){g&&e.cancel(g);h=b;g=e(function(){a.filtro.vetrina.c=h},250)});a.eraseInput=function(b){27===b.key&&(a.input="")};a.updateCheck=function(){return!a.vm.nuovaVetrina.c||!a.vm.nuovaVetrina.n||!a.vm.nuovaVetrina.m||!a.vm.nuovaVetrina.l||!a.vm.nuovaVetrina.r||!a.vm.nuovaVetrina.s||
...
b.data})}).error(function(a,c){console.log(c)})};var h="",g;a.$watch("input",function(b){g&&e.cancel(g);h=b;g=e(function(){if(h||""!==h){var b=[];d.each(a.vm.vetrine,function(a){a.c===h&&b.push(a.i)});a.filtro.vetrinaProdotto.c=b}else a.filtro.vetrinaProdotto.c=!1},250)});a.$watch("inputCod",function(b){g&&e.cancel(g);h=b;g=e(function(){h&&(h=h.toUpperCase());if(""!==h){var b=d.findWhere(a.vm.prodotti,{c:h});b&&(a.filtro.vetrinaProdotto.p=b.i)}else a.filtro.vetrinaProdotto.p=!1},250)});a.eraseInput=
...
!1;k.regioni().then(function(b){a.vm.regioni=b.data})}).error(function(a,c){console.log(c)})};a.updateCheck=function(){return!a.vm.nuovaRegione.n||!a.vm.nuovaRegione.z};a.newItem=function(){c.saving=!1;a.regione.selected=!1;a.errore.regione=!1;a.vm.nuovaRegione={i:a.vm.nuovaRegione.i+1,z:!1}};var h="",g;a.$watch("input",function(b){g&&e.cancel(g);h=b;g=e(function(){a.filtro.regione.n=h},250)});a.eraseInput=function(b){27===b.key&&(a.input="")};a.action=function(b){"N"===b&&(d.findWhere(a.vm.regioni,
...
angular.module("mpuDashboard").controller("provinceCtrl",["$scope","$rootScope","_","dataSvc","$http","$timeout","priceManager",function(a,c,d,k,f,e,h){a.vm.sorting=["z","r","n"];a.provincia={selected:!1};a.vm.priceManager=h;a.$watch("filtro.nazione.i",function(b){a.filtro.regione.i=!1});a.selectItem=function(b){a.provincia={};a.provincia.selected=!0;a.provincia.provincia=b};a.vm.saveProvinceData=function(){c.saving=!0;f.post("php/province.php?type=save",a.vm.province).success(function(){c.saving=
!1}).error(function(a,b){console.log(b)})};a.saveDataDB=function(){c.saving=!0;f.post("php/province.php?type=db",a.vm.province).success(function(){c.saving=!1;k.province().then(function(b){a.vm.province=b.data})}).error(function(a,b){console.log(b)})};a.updateCheck=function(){return!a.vm.nuovaProvincia.n||!a.vm.nuovaProvincia.z};a.newItem=function(){c.saving=!1;a.provincia.selected=!1;a.errore.provincia=!1;a.vm.nuovaProvincia={i:a.vm.nuovaProvincia.i+1,z:!1,r:!1,b:0,l:0,t:0,j:1,m:0,k:1}};var g="",
b;a.$watch("input",function(c){b&&e.cancel(b);g=c;b=e(function(){a.filtro.provincia.n=g},250)});a.eraseInput=function(b){27===b.key&&(a.input="")};a.action=function(b){"N"===b&&(d.findWhere(a.vm.province,{n:a.vm.nuovaProvincia.n,c:a.vm.nuovaProvincia.c,z:a.vm.nuovaProvincia.z,r:a.vm.nuovaProvincia.r})?a.errore.provincia=!0:(c.saving=!0,f.post("php/province.php?type=new",{id:a.vm.nuovaProvincia.i,nome:a.vm.nuovaProvincia.n,sigla:a.vm.nuovaProvincia.c,nazione:a.vm.nuovaProvincia.z,regione:a.vm.nuovaProvincia.r,
...
!1;k.agenti().then(function(b){a.vm.agenti=b.data})}).error(function(a,c){console.log(c)})};var h="",g;a.$watch("input",function(b){g&&e.cancel(g);h=b;g=e(function(){a.filtro.agente.n=h},250)});a.eraseInput=function(b){27===b.key&&(a.input="")};a.updateCheck=function(){return!a.vm.nuovoAgente.n||!a.vm.nuovoAgente.e||!a.vm.nuovoAgente.p||!a.vm.nuovoAgente.r||!a.vm.nuovoAgente.t};a.newItem=function(){c.saving=!1;a.vm.nuovoAgente={i:a.vm.nuovoAgente.i+1,r:!1}};a.action=function(b){"N"===b&&(c.saving=
...
a.saveDataDB();var h="",g;a.$watch("input",function(b){g&&e.cancel(g);h=b;g=e(function(){a.filtro.esposizione.c=h},250)});a.eraseInput=function(b){27===b.key&&(a.input="")};a.updateCheck=function(){return!a.vm.nuovaEsposizione.c||!a.vm.nuovaEsposizione.f||!a.vm.nuovaEsposizione.m||!a.vm.nuovaEsposizione.l||!a.vm.nuovaEsposizione.t||!a.vm.nuovaEsposizione.r||isNaN(a.vm.nuovaEsposizione.y)};a.newItem=function(){c.saving=!1;a.errore.esposizione=!1;a.vm.nuovaEsposizione={i:a.vm.nuovaEsposizione.i+1,m:!1,
...
a.saveDataDB=function(){c.saving=!0;f.post("php/composti.php?type=db").success(function(){c.saving=!1;k.composti().then(function(b){a.vm.composti=b.data})}).error(function(a,c){console.log(c)})};a.saveDataDB();var h="",g;a.$watch("input",function(b){g&&e.cancel(g);h=b;g=e(function(){a.filtro.composto.c=h},250)});a.eraseInput=function(b){27===b.key&&(a.input="")};a.updateCheck=function(){return!a.vm.nuovoComposto.c||!a.vm.nuovoComposto.f||!a.vm.nuovoComposto.m||!a.vm.nuovoComposto.l||!a.vm.nuovoComposto.n||
...
b.data})}).error(function(a,c){console.log(c)})};a.saveDataDB();var h="",g;a.$watch("input",function(b){g&&e.cancel(g);h=b;g=e(function(){if(h||""!==h){var b=[];d.each(a.vm.esposizioni,function(a){a.c===h&&b.push(a.i)});a.filtro.esposizioneProdotto.c=b}else a.filtro.esposizioneProdotto.c=!1},250)});a.$watch("inputCod",function(b){g&&e.cancel(g);h=b;g=e(function(){h&&(h=h.toUpperCase());if(""!==h){var b=d.findWhere(a.vm.prodotti,{c:h});b&&(a.filtro.esposizioneProdotto.p=b.i)}else a.filtro.esposizioneProdotto.p=
...
b.data})}).error(function(a,c){console.log(c)})};a.saveDataDB();var h="",g;a.$watch("input",function(b){g&&e.cancel(g);h=b;g=e(function(){if(h||""!==h){var b=[];d.each(a.vm.composti,function(a){a.c===h&&b.push(a.i)});a.filtro.compostoProdotto.c=b}else a.filtro.compostoProdotto.c=!1},250)});a.$watch("inputCod",function(b){g&&e.cancel(g);h=b;g=e(function(){h&&(h=h.toUpperCase());if(""!==h){var b=d.findWhere(a.vm.prodotti,{c:h});b&&(a.filtro.compostoProdotto.p=b.i)}else a.filtro.compostoProdotto.p=!1},
...
c){console.log(c)})};a.saveDataDB=function(){c.saving=!0;f.post("php/esposizioniSettori.php?type=db").success(function(){c.saving=!1;k.esposizioniSettori().then(function(b){a.vm.esposizioniSettori=b.data})}).error(function(a,c){console.log(c)})};a.saveDataDB();var h="",g;a.$watch("input",function(b){g&&e.cancel(g);h=b;g=e(function(){if(h||""!==h){var b=[];d.each(a.vm.esposizioni,function(a){a.c===h&&b.push(a.i)});a.filtro.esposizioneSettore.c=b}else a.filtro.esposizioneSettore.c=!1},250)});a.eraseInput=
...
!1;k.compostiSettori().then(function(b){a.vm.compostiSettori=b.data})}).error(function(a,c){console.log(c)})};a.saveDataDB();var h="",g;a.$watch("input",function(b){g&&e.cancel(g);h=b;g=e(function(){if(h||""!==h){var b=[];d.each(a.vm.composti,function(a){a.c===h&&b.push(a.i)});a.filtro.compostoSettore.c=b}else a.filtro.compostoSettore.c=!1},250)});a.eraseInput=function(b){27===b.key&&(a.input="")};a.newItem=function(){c.saving=!1;a.errore.compostoSettore=!1;a.vm.nuovoCompostoSettore={i:a.vm.nuovoCompostoSettore.i+
