var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(a,b,f){a instanceof String&&(a=String(a));for(var c=a.length,d=0;d<c;d++){var e=a[d];if(b.call(f,e,d,a))return{i:d,v:e}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(a,b,f){a!=Array.prototype&&a!=Object.prototype&&(a[b]=f.value)};
$jscomp.getGlobal=function(a){return"undefined"!=typeof window&&window===a?a:"undefined"!=typeof global&&null!=global?global:a};$jscomp.global=$jscomp.getGlobal(this);$jscomp.polyfill=function(a,b,f,c){if(b){f=$jscomp.global;a=a.split(".");for(c=0;c<a.length-1;c++){var d=a[c];d in f||(f[d]={});f=f[d]}a=a[a.length-1];c=f[a];b=b(c);b!=c&&null!=b&&$jscomp.defineProperty(f,a,{configurable:!0,writable:!0,value:b})}};
...
!b.entity.tabella||0===b.entity.abbinamenti.length};b.actions=new a.Actions(b,"abbinamenti");b.actions.abbinamenti={add:function(a){a.push({i:!1,n:""})},remove:function(a,b){a.splice(b,1)}};b.actions.reset=function(){b.actions.cleanInputFile();b.entity={marchio:!1,linea:!1,tabella:!1,abbinamenti:[{i:!1,n:""}]}}}}}angular.module("mpuDashboard").directive("prodotti",prodotti);prodotti.$inject=["$rootScope"];
function prodotti(a){return{restrict:"E",templateUrl:"template/prodotti.html",scope:{entity:"="},link:function(b){b.entity=angular.copy(b.entity);b.confirm=!1;b.buildBody=function(){return{cod:b.entity.codice,title:b.entity.titolo,dim:b.entity.dimensioni,note:b.entity.note,tbpr:b.entity.tabella,mark:b.entity.marchio,line:b.entity.linea,price_array:b.entity.prezzi,pos:b.entity.posizione,lnfn:b.entity.finitura_linea,abb:b.entity.finitura_unica,fin:b.entity.finitura_tipo,show:b.entity.show,image:b.entity.immagine}};
b.updateCheck=function(){return!b.entity.codice||!b.entity.titolo||!b.entity.tabella||!b.entity.marchio||!b.entity.linea||!b.entity.settore||!b.entity.immagine};b.actions=new a.Actions(b,"prodotti");b.actions.reset=function(){b.actions.cleanInputFile();b.entity={show:1,prezzo:[{z:0,a:!1}],marchio:!1,linea:!1,finitura_linea:!1,tabella:!1,finitura_tipo:0,finitura_unica:!1,immagine:!1}}}}}
...
angular.module("mpuDashboard").directive("vetrine",function(){return{restrict:"E",templateUrl:"template/vetrine.html",scope:{vetrinaOriginal:"=",vm:"="},controller:function(a,b,f,c){function d(b){_.each(a.vm.marchi,function(a){a.i==b&&(markByName=a.n)});return markByName}function e(b){_.each(a.vm.linee,function(a){a.i==b&&(lineByName=a.n)});return lineByName}a.errore={vetrina:!1};a.generateSettoriInLinea=function(b){if(b){var g=[],e=_.find(a.vm.linee,function(a){return a.i===b}).q;_.each(e,function(b){var e=
_.find(a.vm.settori,function(a){return a.i===b}).n;g.push({i:b,n:e})});return g}};a.selectedCat=function(b){console.log(a.vetrina);return-1!=a.vetrina.s.indexOf(b)};a.toggleSet=function(b){-1==a.vetrina.s.indexOf(b)?a.vetrina.s.push(parseInt(b)):a.vetrina.s.splice(a.vetrina.s.indexOf(b),1)};a.$watch("vetrinaOriginal",function(b){a.vetrina=angular.copy(b.vetrina);b=d(a.vetrina.m);var g=e(a.vetrina.l);b=b.replace(/ /g,"_");g=g.replace(/ /g,"_");a.vetrina.r="../dashboard/archivio_dati/"+b+"/"+g+"/Vetrina/"+
...
a.copyCheck=function(){return!a.vetrina.c||!a.vetrina.m||!a.vetrina.l||a.vetrina.c===a.vetrinaOriginal.vetrina.c&&a.vetrina.l===a.vetrinaOriginal.vetrina.l};a.newVetrina=function(){c.saving=!1;a.errore.vetrina=!1;a.vetrinaOriginal.selected=!1;a.vm.nuovaVetrina={i:a.vm.nuovaVetrina.i+1,m:!1,l:!1,s:!1,y:1,v:1}};a.action=function(g){if("U"==g){var e=a.vetrina.c!=a.vetrinaOriginal.vetrina.c||a.vetrina.l!=a.vetrinaOriginal.vetrina.l?_.findWhere(a.vm.vetrine,{c:a.vetrina.c,l:a.vetrina.l}):!1;e?a.errore.vetrina=
...
angular.module("mpuDashboard").directive("vetrineProdotti",function(){return{restrict:"E",templateUrl:"template/vetrineProdotti.html",scope:{vetrinaProdottoOriginal:"=",vm:"="},controller:function(a,b,f,c){a.$watch("vetrinaProdottoOriginal",function(b){a.vetrinaProdotto=angular.copy(b.vetrinaProdotto)});a.confirm=!1;a.askConfirm=function(){a.confirm=!0;f(function(){a.confirm=!1},4E3)};a.$watch("vetrinaProdotto.p",function(b,e){b!=e&&a.vetrinaProdottoOriginal.i==a.vetrinaProdotto&&(a.vetrinaProdotto.u=
!1);if(b){b=_.findWhere(a.vm.prodotti,{i:b});b=_.pluck(b.z,"a");a.tabsAvailable=[];for(e=0;e<b.length;e++){var g=_.findWhere(a.vm.finitureTabelle,{i:b[e]});a.tabsAvailable.push({i:b[e],n:g.n})}return a.tabsAvailable}});a.$watch("vetrinaProdotto.u",function(b,e){b!=e&&a.vetrinaProdottoOriginal.i==a.vetrinaProdotto&&(a.vetrinaProdotto.f=!1);if(b)return a.finsAvailable=_.where(a.vm.abbinamenti,{u:b}),a.finsAvailable});a.newVetrinaProdotto=function(){c.saving=!1;a.vetrinaProdotto={i:a.vm.nuovoVetrinaProdotto.i+
...
angular.module("mpuDashboard").directive("nazioni",function(){return{restrict:"E",templateUrl:"template/nazioni.html",scope:{cat:"=",vm:"="},controller:function(a,b,f,c){a.confirm=!1;a.askConfirm=function(){a.confirm=!0;f(function(){a.confirm=!1},4E3)};a.updateCheck=function(){return!a.cat.n||!a.cat.x};a.action=function(d){"U"==d&&(c.saving=!0,b.post("php/nazioni.php?type=update",{id:a.cat.i,nome:a.cat.n,show:a.cat.v,prx:a.cat.x}).success(function(b){a.vm.saveNazioniData();c.saving=!1}).error(function(a,
...
angular.module("mpuDashboard").directive("convenzioni",function(){return{restrict:"E",templateUrl:"template/convenzioni.html",scope:{cat:"=",vm:"="},controller:function(a,b,f,c){a.confirm=!1;a.askConfirm=function(){a.confirm=!0;f(function(){a.confirm=!1},4E3)};a.updateCheck=function(){return!a.cat.n};a.action=function(d){"U"==d&&(c.saving=!0,b.post("php/convenzioni.php?type=update",{id:a.cat.i,nome:a.cat.n,email:a.cat.e}).success(function(b){a.vm.saveConvenzioniData();c.saving=!1}).error(function(a,
...
{i:a.vm.nuovoAgente.i+1,r:!1}};a.convert=function(b,e,g){var c=[],d="";if("object"===typeof b){for(var k=0;k<b.length;k++)_.each(a.vm[e],function(a){a.i==b[k]&&c.push(a[g])});return c}_.each(a.vm[e],function(a){a.i==b&&(d=a[g])});return d};a.action=function(d){"U"==d&&(c.saving=!0,b.post("php/agenti.php?type=update",{id:a.agente.i,nome:a.agente.n,email:a.agente.e,password:a.agente.p,tel:a.agente.t,riv:a.agente.r}).success(function(b){a.vm.saveAgentiData();_.each(a.vm.agenti,function(b){b.i==a.agente.i&&
...
b){console.log(b)}))}}}});
angular.module("mpuDashboard").directive("rivenditori",function(){return{restrict:"E",templateUrl:"template/rivenditori.html",scope:{rivenditoreOriginal:"=",vm:"="},controller:function(a,b,f,c){a.errore={rivenditore:!1};a.convert=function(b,g,c){var e=[],d="";if("object"===typeof b){for(var h=0;h<b.length;h++)_.each(a.vm[g],function(a){a.i==b[h]&&e.push(a[c])});return e}_.each(a.vm[g],function(a){a.i==b&&(d=a[c])});return d};a.$watch("rivenditoreOriginal",function(b){a.rivenditore=angular.copy(b.rivenditore);
...
function(a){a.s=0;delete a.n;delete a.b;delete a.g});return a.vm.nuovoRivenditore.y};d();a.newItem=function(){c.saving=!1;a.errore.rivenditore=!1;a.rivenditoreOriginal.selected=!1;a.vm.nuovoRivenditore={i:a.vm.nuovoRivenditore.i+1,z:!1,r:!1,p:!1,b:0,l:0,t:0,j:1,m:0,k:1,v:!1,c:"",h:"",f:"",a:""};d()};a.action=function(e){if("U"==e){var g=a.rivenditore.p&&a.rivenditore.p!=a.rivenditoreOriginal.rivenditore.p?_.findWhere(a.vm.rivenditori,{p:a.rivenditore.p}):!1;g?a.errore.rivenditore=!0:(c.saving=!0,
...
b.l=a.rivenditore.l,b.b=a.rivenditore.b,b.t=a.rivenditore.t,b.j=a.rivenditore.j,b.m=a.rivenditore.m,b.k=a.rivenditore.k,b.y=a.rivenditore.y,b.o=a.rivenditore.o,b.a=a.rivenditore.a,b.g=a.rivenditore.g,a.rivenditore=angular.copy(b))});c.saving=!1;a.errore.rivenditore=!1}).error(function(a,b){console.log(b)}))}"C"==e&&(g=a.rivenditore.p?_.findWhere(a.vm.rivenditori,{p:a.rivenditore.p}):void 0,g?a.errore.rivenditore=!0:(c.saving=!0,b.post("php/rivenditori.php?type=new",{id:a.vm.nuovoRivenditore.i+1,nome:a.rivenditore.n,
...
a.errore.esposizione=!1;a.esposizioneOriginal.selected=!1;a.vm.nuovoComposto={i:a.vm.nuovaEsposizione.i+1,m:!1,l:!1,t:!1,y:1}};a.action=function(g){if("U"==g){var e=a.esposizione.c!=a.esposizioneOriginal.esposizione.c||a.esposizione.l!=a.esposizioneOriginal.esposizione.l||a.esposizione.f!=a.esposizioneOriginal.esposizione.f?_.findWhere(a.vm.esposizioni,{c:a.esposizione.c,l:a.esposizione.l,f:a.esposizione.f}):!1;e?a.errore.esposizione=!0:(c.saving=!0,b.post("php/esposizioni.php?type=update",{id:a.esposizione.i,
...
a.composto.l!==a.compostoOriginal.composto.l||a.composto.f!==a.compostoOriginal.composto.f};a.copyCheck=function(){return!a.composto.c||!a.composto.m||!a.composto.l||!a.composto.f||a.composto.c===a.compostoOriginal.composto.c&&a.composto.l===a.compostoOriginal.composto.l&&a.composto.f===a.compostoOriginal.composto.f};a.newItem=function(){c.saving=!1;a.errore.composto=!1;a.compostoOriginal.selected=!1;a.vm.nuovoComposto={i:a.vm.nuovoComposto.i+1,m:!1,l:!1,y:1}};a.action=function(e){if("U"==e){var g=
...
!1;a.esposizioneSettoreOriginal.selected=!1;a.vm.nuovoEsposizioneSettore={i:a.vm.nuovoEsposizioneSettore.i+1,m:!1,l:!1,c:!1,v:0,h:[]}};a.action=function(e){"U"==e&&(0!=a.esposizioneSettore.h.length?(c.saving=!0,b.post("php/esposizioniSettori.php?type=update",{id:a.esposizioneSettore.i,cod:a.esposizioneSettore.c,mark:a.esposizioneSettore.m,line:a.esposizioneSettore.l,nwln:a.esposizioneSettore.w,array:a.esposizioneSettore.h,view:a.esposizioneSettore.v}).success(function(b){_.each(a.vm.esposizioniSettori,
function(b,c){b.i==a.esposizioneSettore.i&&(b.c=a.esposizioneSettore.c,b.n=a.esposizioneSettore.n,b.m=a.esposizioneSettore.m,b.l=a.esposizioneSettore.l,b.w=a.esposizioneSettore.w,b.h=a.esposizioneSettore.h,b.v=a.esposizioneSettore.v,a.esposizioneSettore=angular.copy(b))});c.saving=!1;a.errore.esposizioneSettore=!1;a.vm.saveEsposizioneSettoreData()}).error(function(a,b){console.log(b)})):a.errore.esposizioneSettore=!0);"C"==e&&(0!=a.esposizioneSettore.h.length?(c.saving=!0,b.post("php/esposizioniSettori.php?type=new",
...
a.vm.nuovoEsposizioneSettore={i:a.vm.nuovoEsposizioneSettore.i+1};a.vm.saveEsposizioneSettoreData();c.saving=!1;a.errore.esposizioneSettore=!1}).error(function(a,b){console.log(b)})):a.errore.esposizioneSettore=!0);"D"==e&&(c.saving=!0,b.post("php/esposizioniSettori.php?type=delete",{id:a.esposizioneSettore.i,cod:a.esposizioneSettore.c,mark:a.esposizioneSettore.m,line:a.esposizioneSettore.l,nwln:a.esposizioneSettore.w,view:a.esposizioneSettore.v,array:a.esposizioneSettore.h}).success(function(b){-1!=
