var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(a,b,g){a instanceof String&&(a=String(a));for(var c=a.length,d=0;d<c;d++){var e=a[d];if(b.call(g,e,d,a))return{i:d,v:e}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(a,b,g){a!=Array.prototype&&a!=Object.prototype&&(a[b]=g.value)};
...
b.entity={show:1,prezzo:3,marchio:!1,linea:!1,settore:!1,immagine:!1}}}}}
angular.module("mpuDashboard").directive("finitureTabelle",function(){return{restrict:"E",templateUrl:"template/finitureTabelle.html",scope:{finituraTabellaOriginal:"=",vm:"="},controller:function(a,b,g,c){a.$watch("finituraTabellaOriginal",function(b){a.finituraTabella=angular.copy(b.finituraTabella)});a.errore={finituraTabella:!1};a.confirm=!1;a.askConfirm=function(){a.confirm=!0;g(function(){a.confirm=!1},4E3)};a.updateCheck=function(){return!a.finituraTabella.n||!a.finituraTabella.m||!a.finituraTabella.l};
a.copyCheck=function(){return!a.finituraTabella.n||!a.finituraTabella.m||!a.finituraTabella.l||a.finituraTabella.n===a.finituraTabellaOriginal.finituraTabella.n&&a.finituraTabella.m===a.finituraTabellaOriginal.finituraTabella.m&&a.finituraTabella.l===a.finituraTabellaOriginal.finituraTabella.l};a.newFinituraTabella=function(){c.saving=!1;a.errore.finituraTabella=!1;a.finituraTabellaOriginal.selected=!1;a.vm.nuovaFinituraTabella={i:a.vm.nuovaFinituraTabella.i+1,m:!1,l:!1}};a.action=function(d){if("U"==
d){var e=a.finituraTabella.n!=a.finituraTabellaOriginal.finituraTabella.n||a.finituraTabella.m!=a.finituraTabellaOriginal.finituraTabella.m||a.finituraTabella.l!=a.finituraTabellaOriginal.finituraTabella.l?_.findWhere(a.vm.finitureTabelle,{n:a.finituraTabella.n,m:a.finituraTabella.m,l:a.finituraTabella.l}):!1;e?a.errore.finituraTabella=!0:(c.saving=!0,b.post("php/finitureTabelle.php?type=update",{id:a.finituraTabella.i,nome:a.finituraTabella.n,line:a.finituraTabella.l,mark:a.finituraTabella.m}).success(function(f){a.vm.saveFinitureTabelleData();
_.each(a.vm.finitureTabelle,function(f){f.i==a.finituraTabella.i&&(f.n=a.finituraTabella.n,f.m=a.finituraTabella.m,f.l=a.finituraTabella.l,a.finituraTabella=angular.copy(f))});c.saving=!1;a.errore.finituraTabella=!1}).error(function(a,b){console.log(b)}))}"C"==d&&(_.findWhere(a.vm.finitureTabelle,{n:a.finituraTabella.n,m:a.finituraTabella.m,l:a.finituraTabella.l})?a.errore.finituraTabella=!0:(c.saving=!0,b.post("php/finitureTabelle.php?type=new",{id:a.vm.nuovaFinituraTabella.i,nome:a.finituraTabella.n,
line:a.finituraTabella.l,mark:a.finituraTabella.m}).success(function(f){a.vm.copiedFinituraTabella={i:a.vm.nuovaFinituraTabella.i,n:a.finituraTabella.n,l:a.finituraTabella.l,m:a.finituraTabella.m};a.vm.finitureTabelle.push(a.vm.copiedFinituraTabella);a.vm.nuovaFinituraTabella={i:a.vm.nuovaFinituraTabella.i+1};a.vm.saveFinitureTabelleData();c.saving=!1;a.errore.finituraTabella=!1}).error(function(a,b){console.log(b)})));"D"==d&&(c.saving=!0,b.post("php/finitureTabelle.php?type=delete",{id:a.finituraTabella.i,
nome:a.finituraTabella.n,line:a.finituraTabella.l,mark:a.finituraTabella.m}).success(function(f){a.vm.finitureTabelle=_.filter(a.vm.finitureTabelle,function(f){return f.i!=a.finituraTabella.i});a.vm.saveFinitureTabelleData();a.newFinituraTabella()}).error(function(a,b){console.log(b)}))}}}});
angular.module("mpuDashboard").directive("abbinamenti",function(){return{restrict:"E",templateUrl:"template/abbinamenti.html",scope:{abbinamentoOriginal:"=",vm:"="},controller:function(a,b,g,c){function d(){return _.filter(a.abbinamento.f,function(a){return!a.i||!a.n}).length}a.$watch("abbinamentoOriginal",function(b){a.abbinamento=angular.copy(b.abbinamento)});a.errore={abbinamento:!1};a.addAbbinamento=function(){a.abbinamento.f.push({i:!1,n:""})};a.removeAbbinamento=function(b){a.abbinamento.f.splice(b,
...
{i:a.vm.nuovoAbbinamento.i+1,m:!1,l:!1,u:!1,f:[{i:!1,n:""}]}};a.action=function(e){if("U"==e){var f=a.abbinamento.c!=a.abbinamentoOriginal.abbinamento.c||a.abbinamento.m!=a.abbinamentoOriginal.abbinamento.m||a.abbinamento.l!=a.abbinamentoOriginal.abbinamento.l?_.findWhere(a.vm.abbinamenti,{n:a.abbinamento.c,m:a.abbinamento.m,l:a.abbinamento.l}):!1;f||0!==d()?a.errore.abbinamento=!0:(c.saving=!0,b.post("php/abbinamenti.php?type=update",{id:a.abbinamento.i,cod:a.abbinamento.c,line:a.abbinamento.l,mark:a.abbinamento.m,
abb_array:a.abbinamento.f,tab:a.abbinamento.u}).success(function(b){a.vm.saveAbbinamentiData();_.each(a.vm.abbinamenti,function(b){b.i==a.abbinamento.i&&(b.c=a.abbinamento.c,b.l=a.abbinamento.l,b.m=a.abbinamento.m,b.f=a.abbinamento.f,b.u=a.abbinamento.u,a.abbinamento=angular.copy(b))});c.saving=!1;a.errore.abbinamento=!1}).error(function(a,b){console.log(b)}))}"C"==e&&(_.findWhere(a.vm.abbinamenti,{c:a.abbinamento.c,m:a.abbinamento.m,l:a.abbinamento.l,u:a.abbinamento.u})?a.errore.abbinamento=!0:(c.saving=
!0,b.post("php/abbinamenti.php?type=new",{id:a.vm.nuovoAbbinamento.i,cod:a.abbinamento.c,line:a.abbinamento.l,mark:a.abbinamento.m,abb_array:a.abbinamento.f,tab:a.abbinamento.u}).success(function(b){a.vm.copiedAbbinamento=angular.copy({i:a.vm.nuovoAbbinamento.i,c:a.abbinamento.c,l:a.abbinamento.l,m:a.abbinamento.m,f:a.abbinamento.f,u:a.abbinamento.u});a.vm.abbinamenti.push(a.vm.copiedAbbinamento);a.vm.nuovoAbbinamento={i:a.vm.nuovoAbbinamento.i+1};a.vm.saveAbbinamentiData();c.saving=!1;a.errore.abbinamento=
!1}).error(function(a,b){console.log(b)})));"D"==e&&(c.saving=!0,b.post("php/abbinamenti.php?type=delete",{id:a.abbinamento.i,cod:a.abbinamento.c,line:a.abbinamento.l,mark:a.abbinamento.m,abb_array:a.abbinamento.f,tab:a.abbinamento.u}).success(function(b){a.vm.abbinamenti=_.filter(a.vm.abbinamenti,function(b){return b.i!=a.abbinamento.i});a.vm.saveAbbinamentiData();a.newAbbinamento()}).error(function(a,b){console.log(b)}))}}}});
angular.module("mpuDashboard").directive("prodotti",function(){return{restrict:"E",templateUrl:"template/prodotti.html",scope:{prodottoOriginal:"=",vm:"="},controller:function(a,b,g,c){function d(b){_.each(a.vm.marchi,function(a){a.i==b&&(markByName=a.n)});return markByName}function e(b){_.each(a.vm.linee,function(a){a.i==b&&(lineByName=a.n)});return lineByName}a.errore={prodotto:!1};a.addProdotto=function(){a.prodotto.z.push({z:"",a:""})};a.removeProdotto=function(b){a.prodotto.z.splice(b,1)};a.$watch("prodottoOriginal",
function(b){a.prodotto=angular.copy(b.prodotto);b=d(a.prodotto.m);var f=e(a.prodotto.l);b=b.replace(/ /g,"_");f=f.replace(/ /g,"_");a.prodotto.r="../dashboard/archivio_dati/"+b+"/"+f+"/Prodotti/"+(a.prodotto.c+".jpg")});a.confirm=!1;a.confirmAll=!1;a.askConfirm=function(b){b?(a.confirmAll=!0,g(function(){a.confirmAll=!1},4E3)):(a.confirm=!0,g(function(){a.confirm=!1},4E3))};a.updateCheck=function(){return!a.prodotto.c||!a.prodotto.n||!a.prodotto.m||!a.prodotto.l||!a.prodotto.x||!a.prodotto.t||!a.prodotto.r};
a.deleteCheck=function(){return a.prodotto.c!==a.prodottoOriginal.prodotto.c||a.prodotto.m!==a.prodottoOriginal.prodotto.m||a.prodotto.l!==a.prodottoOriginal.prodotto.l};a.copyCheck=function(){return!a.prodotto.c||!a.prodotto.m||!a.prodotto.l||a.prodotto.c===a.prodottoOriginal.prodotto.c};var f=function(){return _.filter(a.prodotto.z,function(a){return isNaN(a.z)||!a.z||!a.a}).length};a.newProdotto=function(){c.saving=!1;a.errore.prodotto=!1;a.prodottoOriginal.selected=!1;a.vm.nuovoProdotto={i:a.vm.nuovoProdotto.i+
1,m:!1,l:!1,t:!1,a:"",y:1,f:0,z:[{z:"",a:""}]}};a.action=function(e){if("U"===e){var h=a.prodotto.c!=a.prodottoOriginal.prodotto.c||a.prodotto.l!=a.prodottoOriginal.prodotto.l?_.findWhere(a.vm.prodotti,{c:a.prodotto.c,l:a.prodotto.l}):!1;h||0!==f()?a.errore.prodotto=!0:(c.saving=!0,b.post("php/prodotti.php?type=update",{id:a.prodotto.i,mark:a.prodotto.m,line:a.prodotto.l,cod:a.prodotto.c,title:a.prodotto.n,tbpr:a.prodotto.t,dim:a.prodotto.d,pos:a.prodotto.y,lnfn:a.prodotto.x,note:a.prodotto.o,abb:a.prodotto.a,
...
b.f=a.prodotto.f,b.z=a.prodotto.z,b.r=a.prodotto.r,a.prodotto=angular.copy(b))});c.saving=!1;a.errore.prodotto=!1}).error(function(a,b){console.log(b)}))}"C"===e&&(_.findWhere(a.vm.prodotti,{c:a.prodotto.c,m:a.prodotto.m,l:a.prodotto.l})||0!==f()?a.errore.prodotto=!0:(c.saving=!0,b.post("php/prodotti.php?type=new",{id:a.vm.nuovoProdotto.i,mark:a.prodotto.m,line:a.prodotto.l,cod:a.prodotto.c,title:a.prodotto.n,tbpr:a.prodotto.t,dim:a.prodotto.d,pos:a.prodotto.y,lnfn:a.prodotto.x,note:a.prodotto.o,
...
function(b){b.n=_.findWhere(a.vm.settori,{i:b.h}).n})});a.$watch("prodottoSettore.c",function(b){if(b&&-1!=b){var f=_.find(a.vm.prodotti,function(a){return a.i==b});a.prodottoSettore.n=f.c}});a.selectedCat=function(b){return-1!=a.prodottoSettore.h.indexOf(b)};a.toggleSet=function(b){-1==a.prodottoSettore.h.indexOf(b)?a.prodottoSettore.h.push(parseInt(b)):a.prodottoSettore.h.splice(a.prodottoSettore.h.indexOf(b),1)};a.updateCheck=function(){return-1==a.prodottoSettore.c};a.enableUpdate=!1;a.$watchCollection("prodottoSettore.h",
...
(c.saving=!0,b.post("php/prodottiSettori.php?type=update",{id:a.prodottoSettore.i,cod:a.prodottoSettore.c,mark:a.prodottoSettore.m,line:a.prodottoSettore.l,nwln:a.prodottoSettore.w,array:a.prodottoSettore.h}).success(function(b){_.each(a.vm.prodottiSettori,function(b,f){b.i==a.prodottoSettore.i&&(b.c=a.prodottoSettore.c,b.n=a.prodottoSettore.n,b.m=a.prodottoSettore.m,b.l=a.prodottoSettore.l,b.w=a.prodottoSettore.w,b.h=a.prodottoSettore.h,a.prodottoSettore=angular.copy(b))});c.saving=!1;a.errore.prodottoSettore=
...
angular.module("mpuDashboard").directive("vetrine",function(){return{restrict:"E",templateUrl:"template/vetrine.html",scope:{vetrinaOriginal:"=",vm:"="},controller:function(a,b,g,c){function d(b){_.each(a.vm.marchi,function(a){a.i==b&&(markByName=a.n)});return markByName}function e(b){_.each(a.vm.linee,function(a){a.i==b&&(lineByName=a.n)});return lineByName}a.errore={vetrina:!1};a.generateSettoriInLinea=function(b){if(b){var f=[],e=_.find(a.vm.linee,function(a){return a.i===b}).q;_.each(e,function(b){var e=
_.find(a.vm.settori,function(a){return a.i===b}).n;f.push({i:b,n:e})});return f}};a.selectedCat=function(b){console.log(a.vetrina);return-1!=a.vetrina.s.indexOf(b)};a.toggleSet=function(b){-1==a.vetrina.s.indexOf(b)?a.vetrina.s.push(parseInt(b)):a.vetrina.s.splice(a.vetrina.s.indexOf(b),1)};a.$watch("vetrinaOriginal",function(b){a.vetrina=angular.copy(b.vetrina);b=d(a.vetrina.m);var f=e(a.vetrina.l);b=b.replace(/ /g,"_");f=f.replace(/ /g,"_");a.vetrina.r="../dashboard/archivio_dati/"+b+"/"+f+"/Vetrina/"+
(f+"_"+a.vetrina.c+".jpg")});a.settoriInLinea=!1;a.$watch("vetrina.l",function(b){a.settoriInLinea=a.generateSettoriInLinea(b)});a.confirm=!1;a.askConfirm=function(){a.confirm=!0;g(function(){a.confirm=!1},4E3)};a.updateCheck=function(){return!a.vetrina.c||!a.vetrina.n||!a.vetrina.m||!a.vetrina.l||!a.vetrina.r||!a.vetrina.s||isNaN(a.vetrina.y)};a.deleteCheck=function(){return a.vetrina.c!==a.vetrinaOriginal.vetrina.c||a.vetrina.m!==a.vetrinaOriginal.vetrina.m||a.vetrina.l!==a.vetrinaOriginal.vetrina.l};
a.copyCheck=function(){return!a.vetrina.c||!a.vetrina.m||!a.vetrina.l||a.vetrina.c===a.vetrinaOriginal.vetrina.c&&a.vetrina.l===a.vetrinaOriginal.vetrina.l};a.newVetrina=function(){c.saving=!1;a.errore.vetrina=!1;a.vetrinaOriginal.selected=!1;a.vm.nuovaVetrina={i:a.vm.nuovaVetrina.i+1,m:!1,l:!1,s:!1,y:1,v:1}};a.action=function(f){if("U"==f){var e=a.vetrina.c!=a.vetrinaOriginal.vetrina.c||a.vetrina.l!=a.vetrinaOriginal.vetrina.l?_.findWhere(a.vm.vetrine,{c:a.vetrina.c,l:a.vetrina.l}):!1;e?a.errore.vetrina=
...
a.vetrina.m,b.l=a.vetrina.l,b.c=a.vetrina.c,b.n=a.vetrina.n,b.s=a.vetrina.s,b.v=a.vetrina.v,b.y=a.vetrina.y,b.o=a.vetrina.o,b.r=a.vetrina.r,a.vetrina=angular.copy(b))});c.saving=!1;a.errore.vetrina=!1}).error(function(a,b){console.log(b)}))}"C"==f&&(_.findWhere(a.vm.vetrine,{c:a.vetrina.c,m:a.vetrina.m,l:a.vetrina.l})?a.errore.vetrina=!0:(c.saving=!0,b.post("php/vetrine.php?type=new",{id:a.vm.nuovaVetrina.i,mark:a.vetrina.m,line:a.vetrina.l,cod:a.vetrina.c,title:a.vetrina.n,show:a.vetrina.v,pos:a.vetrina.y,
...
!1;a.errore.vetrina=!1}).error(function(a,b){console.log(b)})));"D"==f&&(c.saving=!0,b.post("php/vetrine.php?type=delete",{id:a.vetrina.i,mark:a.vetrina.m,line:a.vetrina.l,cod:a.vetrina.c,title:a.vetrina.n,show:a.vetrina.v,pos:a.vetrina.y,note:a.vetrina.o,settore:a.vetrina.s,image:a.vetrina.r}).success(function(b){a.vm.vetrine=_.filter(a.vm.vetrine,function(b){return b.i!=a.vetrina.i});a.vm.saveVetrinaData();a.newVetrina()}).error(function(a,b){console.log(b)}))}}}});
angular.module("mpuDashboard").directive("vetrineProdotti",function(){return{restrict:"E",templateUrl:"template/vetrineProdotti.html",scope:{vetrinaProdottoOriginal:"=",vm:"="},controller:function(a,b,g,c){a.$watch("vetrinaProdottoOriginal",function(b){a.vetrinaProdotto=angular.copy(b.vetrinaProdotto)});a.confirm=!1;a.askConfirm=function(){a.confirm=!0;g(function(){a.confirm=!1},4E3)};a.$watch("vetrinaProdotto.p",function(b,e){b!=e&&a.vetrinaProdottoOriginal.i==a.vetrinaProdotto&&(a.vetrinaProdotto.u=
!1);if(b){b=_.findWhere(a.vm.prodotti,{i:b});b=_.pluck(b.z,"a");a.tabsAvailable=[];for(e=0;e<b.length;e++){var f=_.findWhere(a.vm.finitureTabelle,{i:b[e]});a.tabsAvailable.push({i:b[e],n:f.n})}return a.tabsAvailable}});a.$watch("vetrinaProdotto.u",function(b,e){b!=e&&a.vetrinaProdottoOriginal.i==a.vetrinaProdotto&&(a.vetrinaProdotto.f=!1);if(b)return a.finsAvailable=_.where(a.vm.abbinamenti,{u:b}),a.finsAvailable});a.newVetrinaProdotto=function(){c.saving=!1;a.vetrinaProdotto={i:a.vm.nuovoVetrinaProdotto.i+
...
{i:a.vm.nuovoAgente.i+1,r:!1}};a.convert=function(b,e,f){var c=[],d="";if("object"===typeof b){for(var g=0;g<b.length;g++)_.each(a.vm[e],function(a){a.i==b[g]&&c.push(a[f])});return c}_.each(a.vm[e],function(a){a.i==b&&(d=a[f])});return d};a.action=function(d){"U"==d&&(c.saving=!0,b.post("php/agenti.php?type=update",{id:a.agente.i,nome:a.agente.n,email:a.agente.e,password:a.agente.p,tel:a.agente.t,riv:a.agente.r}).success(function(b){a.vm.saveAgentiData();_.each(a.vm.agenti,function(b){b.i==a.agente.i&&
...
b){console.log(b)}))}}}});
angular.module("mpuDashboard").directive("rivenditori",function(){return{restrict:"E",templateUrl:"template/rivenditori.html",scope:{rivenditoreOriginal:"=",vm:"="},controller:function(a,b,g,c){a.errore={rivenditore:!1};a.convert=function(b,f,c){var e=[],d="";if("object"===typeof b){for(var h=0;h<b.length;h++)_.each(a.vm[f],function(a){a.i==b[h]&&e.push(a[c])});return e}_.each(a.vm[f],function(a){a.i==b&&(d=a[c])});return d};a.$watch("rivenditoreOriginal",function(b){a.rivenditore=angular.copy(b.rivenditore);
...
function(a){a.s=0;delete a.n;delete a.b;delete a.g});return a.vm.nuovoRivenditore.y};d();a.newItem=function(){c.saving=!1;a.errore.rivenditore=!1;a.rivenditoreOriginal.selected=!1;a.vm.nuovoRivenditore={i:a.vm.nuovoRivenditore.i+1,z:!1,r:!1,p:!1,b:0,l:0,t:0,j:1,m:0,k:1,v:!1,c:"",h:"",f:"",a:""};d()};a.action=function(e){if("U"==e){var f=a.rivenditore.p&&a.rivenditore.p!=a.rivenditoreOriginal.rivenditore.p?_.findWhere(a.vm.rivenditori,{p:a.rivenditore.p}):!1;f?a.errore.rivenditore=!0:(c.saving=!0,
...
var c=e(a.esposizione.l);b=b.replace(/ /g,"_");c=c.replace(/ /g,"_");var f=a.esposizione.f.replace(/ /g,"_");a.esposizione.r="../dashboard/archivio_dati/"+b+"/"+c+"/Render/"+(c+"_"+a.esposizione.c+"_"+f+".jpg")});a.confirm=!1;a.askConfirm=function(){a.confirm=!0;g(function(){a.confirm=!1},4E3)};a.updateCheck=function(){return!a.esposizione.c||!a.esposizione.f||!a.esposizione.m||!a.esposizione.l||!a.esposizione.t||!a.esposizione.r||isNaN(a.esposizione.y)};a.deleteCheck=function(){return a.esposizione.c!==
...
a.errore.esposizione=!1;a.esposizioneOriginal.selected=!1;a.vm.nuovoComposto={i:a.vm.nuovaEsposizione.i+1,m:!1,l:!1,t:!1,y:1}};a.action=function(f){if("U"==f){var e=a.esposizione.c!=a.esposizioneOriginal.esposizione.c||a.esposizione.l!=a.esposizioneOriginal.esposizione.l||a.esposizione.f!=a.esposizioneOriginal.esposizione.f?_.findWhere(a.vm.esposizioni,{c:a.esposizione.c,l:a.esposizione.l,f:a.esposizione.f}):!1;e?a.errore.esposizione=!0:(c.saving=!0,b.post("php/esposizioni.php?type=update",{id:a.esposizione.i,
...
b=b.replace(/ /g,"_");c=c.replace(/ /g,"_");var f=a.composto.f.replace(/ /g,"_");a.composto.r="../dashboard/archivio_dati/"+b+"/"+c+"/Render/"+(c+"_"+a.composto.c+"C_"+f+".jpg")});a.confirm=!1;a.askConfirm=function(){a.confirm=!0;g(function(){a.confirm=!1},4E3)};a.updateCheck=function(){return!a.composto.c||!a.composto.f||!a.composto.m||!a.composto.l||!a.composto.n||!a.composto.r||isNaN(a.composto.y)};a.deleteCheck=function(){return a.composto.c!==a.compostoOriginal.composto.c||a.composto.m!==a.compostoOriginal.composto.m||
a.composto.l!==a.compostoOriginal.composto.l||a.composto.f!==a.compostoOriginal.composto.f};a.copyCheck=function(){return!a.composto.c||!a.composto.m||!a.composto.l||!a.composto.f||a.composto.c===a.compostoOriginal.composto.c&&a.composto.l===a.compostoOriginal.composto.l&&a.composto.f===a.compostoOriginal.composto.f};a.newItem=function(){c.saving=!1;a.errore.composto=!1;a.compostoOriginal.selected=!1;a.vm.nuovoComposto={i:a.vm.nuovoComposto.i+1,m:!1,l:!1,y:1}};a.action=function(f){if("U"==f){var e=
a.composto.c!=a.compostoOriginal.composto.c||a.composto.l!=a.compostoOriginal.composto.l||a.composto.f!=a.compostoOriginal.composto.f?_.findWhere(a.vm.composti,{c:a.composto.c,l:a.composto.l,f:a.composto.f}):!1;e?a.errore.composto=!0:(c.saving=!0,b.post("php/composti.php?type=update",{id:a.composto.i,mark:a.composto.m,line:a.composto.l,cod:a.composto.c,fin:a.composto.f,pos:a.composto.y,nome:a.composto.n,image:a.composto.r,sourceCod:a.compostoOriginal.composto.c,sourceMark:a.compostoOriginal.composto.m,
sourceLine:a.compostoOriginal.composto.l,sourceFin:a.compostoOriginal.composto.f}).success(function(b){a.errore.composto=!1;a.vm.saveCompostoData();console.log("Risposta dalla pagina PHP",b);_.each(a.vm.composti,function(b){b.i==a.composto.i&&(b.m=a.composto.m,b.l=a.composto.l,b.c=a.composto.c,b.f=a.composto.f,b.y=a.composto.y,b.n=a.composto.n,b.r=a.composto.r,a.composto=angular.copy(b))});c.saving=!1;a.errore.composto=!1}).error(function(a,b){console.log(b)}))}"C"==f&&(_.findWhere(a.vm.composti,
...
b);a.vm.copiedComposto={i:a.vm.nuovoComposto.i,m:a.composto.m,l:a.composto.l,c:a.composto.c,f:a.composto.f,y:a.composto.y,n:a.composto.n};a.vm.composti.push(a.vm.copiedComposto);a.vm.nuovoComposto={i:a.vm.nuovoComposto.i+1};a.vm.saveCompostoData();c.saving=!1;a.errore.composto=!1}).error(function(a,b){console.log(b)})));"D"==f&&(c.saving=!0,b.post("php/composti.php?type=delete",{id:a.composto.i,mark:a.composto.m,line:a.composto.l,cod:a.composto.c,fin:a.composto.f,pos:a.composto.y,nome:a.composto.n,
