...
[{n:"basso",i:1},{n:"medio/basso",i:2},{n:"medio",i:3},{n:"medio/alto",i:4},{n:"alto",i:5}];a.$watch("lineaSettoreOriginal",function(c){a.lineaSettore=angular.copy(c.lineaSettore);c=f(a.lineaSettore.m);var h=d(a.lineaSettore.l),e=b(a.lineaSettore.h);c=c.replace(/ /g,"_");h=h.replace(/ /g,"_");e=e.replace(/ /g,"_");a.lineaSettore.r="../dashboard/archivio_dati/"+c+"/"+h+"/Vetrina/"+(h+"_"+e+".jpg")});a.confirm=!1;a.askConfirm=function(){a.confirm=!0;g(function(){a.confirm=!1},4E3)};a.toggleSet=function(b){-1==
a.lineaSettore.q.indexOf(b)?a.lineaSettore.q.push(parseInt(b)):a.lineaSettore.q.splice(a.lineaSettore.q.indexOf(b),1)};a.checkList=function(b){return-1!=a.lineaSettore.q.indexOf(b)};a.updateCheck=function(){return!a.lineaSettore.m||!a.lineaSettore.l||!a.lineaSettore.h};a.deleteCheck=function(){return a.lineaSettore.m!==a.lineaSettoreOriginal.lineaSettore.m||a.lineaSettore.l!==a.lineaSettoreOriginal.lineaSettore.l||a.lineaSettore.h!==a.lineaSettoreOriginal.lineaSettore.h};a.newItem=function(){c.saving=
!1;a.lineaSettoreOriginal.selected=!1;a.vm.nuovaLineaSettore={i:a.vm.nuovaLineaSettore.i+1,v:1,p:0,z:1,q:[],m:!1,r:!1};a.errore.lineaSettore=!1};a.action=function(b){if("U"==b){var d=a.lineaSettore.m!=a.lineaSettoreOriginal.lineaSettore.m||a.lineaSettore.l!=a.lineaSettoreOriginal.lineaSettore.l||a.lineaSettore.h!=a.lineaSettoreOriginal.lineaSettore.h?_.findWhere(a.vm.lineeSettori,{m:a.lineaSettore.m,l:a.lineaSettore.l,h:a.lineaSettore.h}):!1;d||0==a.lineaSettore.q.length?a.errore.lineaSettore=!0:
(c.saving=!0,e.post("php/lineeSettori.php?type=update",{id:a.lineaSettore.i,mark:a.lineaSettore.m,line:a.lineaSettore.l,set:a.lineaSettore.h,show:a.lineaSettore.v,price:a.lineaSettore.z,man:a.lineaSettore.q,image:a.lineaSettore.r,sourceMark:a.lineaSettoreOriginal.lineaSettore.m,sourceLine:a.lineaSettoreOriginal.lineaSettore.l,sourceSet:a.lineaSettoreOriginal.lineaSettore.h}).success(function(b){a.errore.lineaSettore=!1;a.vm.saveLineaSettoreData();console.log("Risposta dalla pagina PHP",b);_.each(a.vm.lineeSettori,
function(b){b.i==a.lineaSettore.i&&(b.m=a.lineaSettore.m,b.l=a.lineaSettore.l,b.h=a.lineaSettore.h,b.r=a.lineaSettore.r,b.z=a.lineaSettore.z,b.q=a.lineaSettore.q,b.v=a.lineaSettore.v,a.lineaSettore=angular.copy(b))});c.saving=!1}).error(function(a,b){console.log(b)}))}"D"==b&&(c.saving=!0,e.post("php/lineeSettori.php?type=delete",{id:a.lineaSettore.i,mark:a.lineaSettore.m,line:a.lineaSettore.l,set:a.lineaSettore.h,show:a.lineaSettore.v,price:a.lineaSettore.z,man:a.lineaSettore.q,image:a.lineaSettore.r}).success(function(b){a.vm.lineeSettori=
