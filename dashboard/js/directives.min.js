var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(a,b,f){a instanceof String&&(a=String(a));for(var c=a.length,e=0;e<c;e++){var d=a[e];if(b.call(f,d,e,a))return{i:e,v:d}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(a,b,f){a!=Array.prototype&&a!=Object.prototype&&(a[b]=f.value)};
$jscomp.getGlobal=function(a){return"undefined"!=typeof window&&window===a?a:"undefined"!=typeof global&&null!=global?global:a};$jscomp.global=$jscomp.getGlobal(this);$jscomp.polyfill=function(a,b,f,c){if(b){f=$jscomp.global;a=a.split(".");for(c=0;c<a.length-1;c++){var e=a[c];e in f||(f[e]={});f=f[e]}a=a[a.length-1];c=f[a];b=b(c);b!=c&&null!=b&&$jscomp.defineProperty(f,a,{configurable:!0,writable:!0,value:b})}};
$jscomp.polyfill("Array.prototype.find",function(a){return a?a:function(a,f){return $jscomp.findInternal(this,a,f).v}},"es6","es3");angular.module("mpuDashboard").directive("fileRead",fileRead);function fileRead(){return{scope:{fileRead:"="},link:function(a,b){b.bind("change",function(b){var c=new FileReader;c.onload=function(b){a.$apply(function(){a.fileRead=b.target.result})};c.readAsDataURL(b.target.files[0])})}}}angular.module("mpuDashboard").directive("categorie",categorie);
...
function linee(a){return{restrict:"E",templateUrl:"template/linee.html",scope:{entity:"="},link:function(b){b.entity=angular.copy(b.entity);b.confirm=!1;b.buildBody=function(){var a=[];0<b.entity.abbinamenti.length&&_.each(b.entity.abbinamenti,function(b){b.categoria&&b.settore&&b.linea&&a.push(JSON.parse(angular.toJson(b)))});return{nome:b.entity.nome,mark:b.entity.marchio,cat:b.entity.categoria,show:b.entity.show,vtr:b.entity.vetrina,time:b.entity.consegna,war:b.entity.garanzia,disc:b.entity.sconto,
pos:b.entity.posizione,link:a,ctl:b.entity.catalogo,spc:b.entity.specifiche}};b.updateCheck=function(){return!b.entity.nome||!b.entity.marchio||!b.entity.categoria||!b.entity.posizione};b.actions=new a.Actions(b,"linee");b.actions.abbinamenti={add:function(a){a.push({categoria:!1,settore:!1,linea:!1})},reset:function(a){a.length=0},remove:function(a,b){a.splice(b,1)}};b.actions.reset=function(){b.actions.cleanInputFile();b.entity={show:1,vetrina:0,posizione:0,consegna:25,garanzia:2,sconto:0,marchio:!1,
categoria:!1,catalogo:"",specifiche:"",abbinamenti:[]}}}}}angular.module("mpuDashboard").directive("settoriLinee",settoriLinee);settoriLinee.$inject=["$rootScope"];
function settoriLinee(a){return{restrict:"E",templateUrl:"template/settori_linee.html",scope:{entity:"="},link:function(b){b.entity=angular.copy(b.entity);b.confirm=!1;b.buildBody=function(){return{mark:b.entity.marchio,line:b.entity.linea,set:b.entity.settore,show:b.entity.show,price:b.entity.prezzo,image:b.entity.immagine}};b.updateCheck=function(){return!b.entity.marchio||!b.entity.linea||!b.entity.settore||!b.entity.immagine};b.actions=new a.Actions(b,"settori_linee");b.actions.reset=function(){b.actions.cleanInputFile();
b.entity={show:1,prezzo:3,marchio:!1,linea:!1,settore:!1,immagine:!1}}}}}angular.module("mpuDashboard").directive("tabelleFiniture",tabelleFiniture);tabelleFiniture.$inject=["$rootScope"];
function tabelleFiniture(a){return{restrict:"E",templateUrl:"template/tabelle_finiture.html",scope:{entity:"="},link:function(b){b.entity=angular.copy(b.entity);b.confirm=!1;b.buildBody=function(){return{nome:b.entity.nome,line:b.entity.linea,mark:b.entity.marchio}};b.updateCheck=function(){return!b.entity.nome||!b.entity.marchio||!b.entity.linea};b.actions=new a.Actions(b,"tabelle_finiture");b.actions.reset=function(){b.entity={linea:!1,marchio:!1}}}}}
angular.module("mpuDashboard").directive("abbinamenti",abbinamenti);abbinamenti.$inject=["$rootScope"];
function abbinamenti(a){return{restrict:"E",templateUrl:"template/abbinamenti.html",scope:{entity:"="},link:function(b){b.entity=angular.copy(b.entity);b.confirm=!1;b.buildBody=function(){var a=[];0<b.entity.abbinamenti.length&&_.each(b.entity.abbinamenti,function(b){b.i&&b.n&&a.push(JSON.parse(angular.toJson(b)))});return{cod:b.entity.codice,mark:b.entity.marchio,line:b.entity.linea,tab:b.entity.tabella,abb_array:a}};b.updateCheck=function(){return!b.entity.codice||!b.entity.marchio||!b.entity.linea||
!b.entity.tabella||0===b.entity.abbinamenti.length};b.actions=new a.Actions(b,"abbinamenti");b.actions.abbinamenti={add:function(a){a.push({i:!1,n:""})},remove:function(a,b){a.splice(b,1)}};b.actions.reset=function(){b.actions.cleanInputFile();b.entity={marchio:!1,linea:!1,tabella:!1,abbinamenti:[{i:!1,n:""}]}}}}}
angular.module("mpuDashboard").directive("prodotti",function(){return{restrict:"E",templateUrl:"template/prodotti.html",scope:{prodottoOriginal:"=",vm:"="},controller:function(a,b,f,c){function e(b){_.each(a.vm.marchi,function(a){a.i==b&&(markByName=a.n)});return markByName}function d(b){_.each(a.vm.linee,function(a){a.i==b&&(lineByName=a.n)});return lineByName}a.errore={prodotto:!1};a.addProdotto=function(){a.prodotto.z.push({z:"",a:""})};a.removeProdotto=function(b){a.prodotto.z.splice(b,1)};a.$watch("prodottoOriginal",
function(b){a.prodotto=angular.copy(b.prodotto);b=e(a.prodotto.m);var g=d(a.prodotto.l);b=b.replace(/ /g,"_");g=g.replace(/ /g,"_");a.prodotto.r="../dashboard/archivio_dati/"+b+"/"+g+"/Prodotti/"+(a.prodotto.c+".jpg")});a.confirm=!1;a.confirmAll=!1;a.askConfirm=function(b){b?(a.confirmAll=!0,f(function(){a.confirmAll=!1},4E3)):(a.confirm=!0,f(function(){a.confirm=!1},4E3))};a.updateCheck=function(){return!a.prodotto.c||!a.prodotto.n||!a.prodotto.m||!a.prodotto.l||!a.prodotto.x||!a.prodotto.t||!a.prodotto.r};
a.deleteCheck=function(){return a.prodotto.c!==a.prodottoOriginal.prodotto.c||a.prodotto.m!==a.prodottoOriginal.prodotto.m||a.prodotto.l!==a.prodottoOriginal.prodotto.l};a.copyCheck=function(){return!a.prodotto.c||!a.prodotto.m||!a.prodotto.l||a.prodotto.c===a.prodottoOriginal.prodotto.c};var g=function(){return _.filter(a.prodotto.z,function(a){return isNaN(a.z)||!a.z||!a.a}).length};a.newProdotto=function(){c.saving=!1;a.errore.prodotto=!1;a.prodottoOriginal.selected=!1;a.vm.nuovoProdotto={i:a.vm.nuovoProdotto.i+
1,m:!1,l:!1,t:!1,a:"",y:1,f:0,z:[{z:"",a:""}]}};a.action=function(d){if("U"===d){var h=a.prodotto.c!=a.prodottoOriginal.prodotto.c||a.prodotto.l!=a.prodottoOriginal.prodotto.l?_.findWhere(a.vm.prodotti,{c:a.prodotto.c,l:a.prodotto.l}):!1;h||0!==g()?a.errore.prodotto=!0:(c.saving=!0,b.post("php/prodotti.php?type=update",{id:a.prodotto.i,mark:a.prodotto.m,line:a.prodotto.l,cod:a.prodotto.c,title:a.prodotto.n,tbpr:a.prodotto.t,dim:a.prodotto.d,pos:a.prodotto.y,lnfn:a.prodotto.x,note:a.prodotto.o,abb:a.prodotto.a,
...
b.f=a.prodotto.f,b.z=a.prodotto.z,b.r=a.prodotto.r,a.prodotto=angular.copy(b))});c.saving=!1;a.errore.prodotto=!1}).error(function(a,b){console.log(b)}))}"C"===d&&(_.findWhere(a.vm.prodotti,{c:a.prodotto.c,m:a.prodotto.m,l:a.prodotto.l})||0!==g()?a.errore.prodotto=!0:(c.saving=!0,b.post("php/prodotti.php?type=new",{id:a.vm.nuovoProdotto.i,mark:a.prodotto.m,line:a.prodotto.l,cod:a.prodotto.c,title:a.prodotto.n,tbpr:a.prodotto.t,dim:a.prodotto.d,pos:a.prodotto.y,lnfn:a.prodotto.x,note:a.prodotto.o,
...
{i:a.vm.nuovoProdotto.i+1};a.vm.saveProdottoData();c.saving=!1;a.errore.prodotto=!1}).error(function(a,b){console.log(b)})));"D"===d&&(c.saving=!0,b.post("php/prodotti.php?type=delete",{id:a.prodotto.i,mark:a.prodotto.m,line:a.prodotto.l,cod:a.prodotto.c,title:a.prodotto.n,tbpr:a.prodotto.t,dim:a.prodotto.d,pos:a.prodotto.y,lnfn:a.prodotto.x,note:a.prodotto.o,abb:a.prodotto.a,fin:a.prodotto.f,prices:a.prodotto.z,image:a.prodotto.r}).success(function(b){console.log("Risposta dalla pagina PHP",b);a.vm.prodotti=
_.filter(a.vm.prodotti,function(b){return b.i!=a.prodotto.i});a.vm.saveProdottoData();a.newProdotto()}).error(function(a,b){console.log(b)}));"A"===d&&(c.saving=!0,b.post("php/prodotti.php?type=deleteAll",{mark:a.prodotto.m,line:a.prodotto.l}).success(function(b){console.log("Risposta dalla pagina PHP",b);a.vm.prodotti=_.filter(a.vm.prodotti,function(b){return b.i!=a.prodotto.i});a.vm.saveProdottoData();a.newProdotto()}).error(function(a,b){console.log(b)}))}}}});
angular.module("mpuDashboard").directive("prodottiSettori",function(){return{restrict:"E",templateUrl:"template/prodottiSettori.html",scope:{prodottoSettoreOriginal:"=",vm:"="},controller:function(a,b,f,c,e){a.$watch("prodottoSettoreOriginal",function(b){a.prodottoSettore=angular.copy(b.prodottoSettore)});a.saveDataDB=function(){c.saving=!0;b.post("php/prodottiSettori.php?type=db").success(function(){c.saving=!1;e.prodottiSettori().then(function(b){a.vm.prodottiSettori=b})}).error(function(a,b){console.log(b)})};
a.errore={prodottoSettore:!1};a.confirm=!1;a.askConfirm=function(){a.confirm=!0;f(function(){a.confirm=!1},4E3)};a.$watch("prodottoSettore",function(b){a.prodottiAvailable=[{c:" Tutti",i:-1},{c:a.prodottoSettore.n,i:a.prodottoSettore.c}];b=_.where(a.vm.prodotti,{l:b.l});_.each(b,function(b){_.find(a.vm.prodottiSettori,function(a){return a.c===b.i})||a.prodottiAvailable.push(b)})});a.$watch("prodottoSettore.w",function(b){a.settoriAvailable=_.where(a.vm.lineeSettori,{l:b});_.each(a.settoriAvailable,
function(b){b.n=_.findWhere(a.vm.settori,{i:b.h}).n})});a.$watch("prodottoSettore.c",function(b){if(b&&-1!=b){var g=_.find(a.vm.prodotti,function(a){return a.i==b});a.prodottoSettore.n=g.c}});a.selectedCat=function(b){return-1!=a.prodottoSettore.h.indexOf(b)};a.toggleSet=function(b){-1==a.prodottoSettore.h.indexOf(b)?a.prodottoSettore.h.push(parseInt(b)):a.prodottoSettore.h.splice(a.prodottoSettore.h.indexOf(b),1)};a.updateCheck=function(){return-1==a.prodottoSettore.c};a.enableUpdate=!1;a.$watchCollection("prodottoSettore.h",
...
angular.module("mpuDashboard").directive("vetrine",function(){return{restrict:"E",templateUrl:"template/vetrine.html",scope:{vetrinaOriginal:"=",vm:"="},controller:function(a,b,f,c){function e(b){_.each(a.vm.marchi,function(a){a.i==b&&(markByName=a.n)});return markByName}function d(b){_.each(a.vm.linee,function(a){a.i==b&&(lineByName=a.n)});return lineByName}a.errore={vetrina:!1};a.generateSettoriInLinea=function(b){if(b){var g=[],d=_.find(a.vm.linee,function(a){return a.i===b}).q;_.each(d,function(b){var d=
_.find(a.vm.settori,function(a){return a.i===b}).n;g.push({i:b,n:d})});return g}};a.selectedCat=function(b){console.log(a.vetrina);return-1!=a.vetrina.s.indexOf(b)};a.toggleSet=function(b){-1==a.vetrina.s.indexOf(b)?a.vetrina.s.push(parseInt(b)):a.vetrina.s.splice(a.vetrina.s.indexOf(b),1)};a.$watch("vetrinaOriginal",function(b){a.vetrina=angular.copy(b.vetrina);b=e(a.vetrina.m);var g=d(a.vetrina.l);b=b.replace(/ /g,"_");g=g.replace(/ /g,"_");a.vetrina.r="../dashboard/archivio_dati/"+b+"/"+g+"/Vetrina/"+
(g+"_"+a.vetrina.c+".jpg")});a.settoriInLinea=!1;a.$watch("vetrina.l",function(b){a.settoriInLinea=a.generateSettoriInLinea(b)});a.confirm=!1;a.askConfirm=function(){a.confirm=!0;f(function(){a.confirm=!1},4E3)};a.updateCheck=function(){return!a.vetrina.c||!a.vetrina.n||!a.vetrina.m||!a.vetrina.l||!a.vetrina.r||!a.vetrina.s||isNaN(a.vetrina.y)};a.deleteCheck=function(){return a.vetrina.c!==a.vetrinaOriginal.vetrina.c||a.vetrina.m!==a.vetrinaOriginal.vetrina.m||a.vetrina.l!==a.vetrinaOriginal.vetrina.l};
a.copyCheck=function(){return!a.vetrina.c||!a.vetrina.m||!a.vetrina.l||a.vetrina.c===a.vetrinaOriginal.vetrina.c&&a.vetrina.l===a.vetrinaOriginal.vetrina.l};a.newVetrina=function(){c.saving=!1;a.errore.vetrina=!1;a.vetrinaOriginal.selected=!1;a.vm.nuovaVetrina={i:a.vm.nuovaVetrina.i+1,m:!1,l:!1,s:!1,y:1,v:1}};a.action=function(g){if("U"==g){var d=a.vetrina.c!=a.vetrinaOriginal.vetrina.c||a.vetrina.l!=a.vetrinaOriginal.vetrina.l?_.findWhere(a.vm.vetrine,{c:a.vetrina.c,l:a.vetrina.l}):!1;d?a.errore.vetrina=
...
a.vetrina.m,b.l=a.vetrina.l,b.c=a.vetrina.c,b.n=a.vetrina.n,b.s=a.vetrina.s,b.v=a.vetrina.v,b.y=a.vetrina.y,b.o=a.vetrina.o,b.r=a.vetrina.r,a.vetrina=angular.copy(b))});c.saving=!1;a.errore.vetrina=!1}).error(function(a,b){console.log(b)}))}"C"==g&&(_.findWhere(a.vm.vetrine,{c:a.vetrina.c,m:a.vetrina.m,l:a.vetrina.l})?a.errore.vetrina=!0:(c.saving=!0,b.post("php/vetrine.php?type=new",{id:a.vm.nuovaVetrina.i,mark:a.vetrina.m,line:a.vetrina.l,cod:a.vetrina.c,title:a.vetrina.n,show:a.vetrina.v,pos:a.vetrina.y,
...
!1;a.errore.vetrina=!1}).error(function(a,b){console.log(b)})));"D"==g&&(c.saving=!0,b.post("php/vetrine.php?type=delete",{id:a.vetrina.i,mark:a.vetrina.m,line:a.vetrina.l,cod:a.vetrina.c,title:a.vetrina.n,show:a.vetrina.v,pos:a.vetrina.y,note:a.vetrina.o,settore:a.vetrina.s,image:a.vetrina.r}).success(function(b){a.vm.vetrine=_.filter(a.vm.vetrine,function(b){return b.i!=a.vetrina.i});a.vm.saveVetrinaData();a.newVetrina()}).error(function(a,b){console.log(b)}))}}}});
angular.module("mpuDashboard").directive("vetrineProdotti",function(){return{restrict:"E",templateUrl:"template/vetrineProdotti.html",scope:{vetrinaProdottoOriginal:"=",vm:"="},controller:function(a,b,f,c){a.$watch("vetrinaProdottoOriginal",function(b){a.vetrinaProdotto=angular.copy(b.vetrinaProdotto)});a.confirm=!1;a.askConfirm=function(){a.confirm=!0;f(function(){a.confirm=!1},4E3)};a.$watch("vetrinaProdotto.p",function(b,d){b!=d&&a.vetrinaProdottoOriginal.i==a.vetrinaProdotto&&(a.vetrinaProdotto.u=
!1);if(b){b=_.findWhere(a.vm.prodotti,{i:b});b=_.pluck(b.z,"a");a.tabsAvailable=[];for(d=0;d<b.length;d++){var g=_.findWhere(a.vm.finitureTabelle,{i:b[d]});a.tabsAvailable.push({i:b[d],n:g.n})}return a.tabsAvailable}});a.$watch("vetrinaProdotto.u",function(b,d){b!=d&&a.vetrinaProdottoOriginal.i==a.vetrinaProdotto&&(a.vetrinaProdotto.f=!1);if(b)return a.finsAvailable=_.where(a.vm.abbinamenti,{u:b}),a.finsAvailable});a.newVetrinaProdotto=function(){c.saving=!1;a.vetrinaProdotto={i:a.vm.nuovoVetrinaProdotto.i+
1,c:!1,p:!1,m:!1,k:!1,l:!1,j:!1,u:!1,f:!1,y:1,q:1}};a.updateCheck=function(){return!a.vetrinaProdotto.c||!a.vetrinaProdotto.p||!a.vetrinaProdotto.l||!a.vetrinaProdotto.j||!a.vetrinaProdotto.u||!a.vetrinaProdotto.f||isNaN(a.vetrinaProdotto.y)||isNaN(a.vetrinaProdotto.q)};a.action=function(e){"U"==e&&(c.saving=!0,b.post("php/vetrineProdotti.php?type=update",{id:a.vetrinaProdotto.i,comp:a.vetrinaProdotto.c,prd:a.vetrinaProdotto.p,pline:a.vetrinaProdotto.l,cline:a.vetrinaProdotto.j,pmark:a.vetrinaProdotto.m,
...
angular.module("mpuDashboard").directive("nazioni",function(){return{restrict:"E",templateUrl:"template/nazioni.html",scope:{cat:"=",vm:"="},controller:function(a,b,f,c){a.confirm=!1;a.askConfirm=function(){a.confirm=!0;f(function(){a.confirm=!1},4E3)};a.updateCheck=function(){return!a.cat.n||!a.cat.x};a.action=function(e){"U"==e&&(c.saving=!0,b.post("php/nazioni.php?type=update",{id:a.cat.i,nome:a.cat.n,show:a.cat.v,prx:a.cat.x}).success(function(b){a.vm.saveNazioniData();c.saving=!1}).error(function(a,
b){console.log(b)}));"D"==e&&(c.saving=!0,b.post("php/nazioni.php?type=delete",{id:a.cat.i,nome:a.cat.n,show:a.cat.v,prx:a.cat.x}).success(function(b){a.vm.nazioni=_.filter(a.vm.nazioni,function(b){return b.i!=a.cat.i});a.vm.saveNazioniData();c.saving=!1}).error(function(a,b){console.log(b)}))}}}});
angular.module("mpuDashboard").directive("regioni",function(){return{restrict:"E",templateUrl:"template/regioni.html",scope:{regioneOriginal:"=",vm:"="},controller:function(a,b,f,c){a.$watch("regioneOriginal",function(b){a.regione=angular.copy(b.regione)});a.errore={regione:!1};a.confirm=!1;a.askConfirm=function(){a.confirm=!0;f(function(){a.confirm=!1},4E3)};a.updateCheck=function(){return!a.regione.n||!a.regione.z};a.newItem=function(){a.regioneOriginal.selected=!1;a.errore.regione=!1;c.saving=
!1;a.vm.nuovaRegione={i:a.vm.nuovaRegione.i+1,z:!1}};a.action=function(e){"U"==e&&(_.findWhere(a.vm.regioni,{n:a.regione.n,z:a.regione.z})?a.errore.regione=!0:(c.saving=!0,b.post("php/regioni.php?type=update",{id:a.regione.i,nome:a.regione.n,nazione:a.regione.z}).success(function(b){a.vm.saveRegioniData();_.each(a.vm.regioni,function(b){b.i==a.regione.i&&(b.n=a.regione.n,b.z=a.regione.z,a.regione=angular.copy(b))});c.saving=!1}).error(function(a,b){console.log(b)})));"D"==e&&(c.saving=!0,b.post("php/regioni.php?type=delete",
...
angular.module("mpuDashboard").directive("province",function(){return{restrict:"E",templateUrl:"template/province.html",scope:{provinciaOriginal:"=",vm:"="},controller:function(a,b,f,c){a.$watch("provinciaOriginal",function(b){a.provincia=angular.copy(b.provincia)});a.errore={provincia:!1};a.confirm=!1;a.askConfirm=function(){a.confirm=!0;f(function(){a.confirm=!1},4E3)};a.copyCheck=function(){return!a.provincia.n||!a.provincia.c||!a.provincia.r||!a.provincia.z||a.provincia.n===a.provinciaOriginal.provincia.n};
a.newItem=function(){c.saving=!1;a.provinciaOriginal.selected=!1;a.errore.provincia=!1;a.vm.nuovaProvincia={i:a.vm.nuovaProvincia.i+1,z:!1,r:!1,b:0,l:0,t:0,j:1,m:0,k:1}};a.action=function(e){"U"==e&&(a.provincia.n&&a.provincia.z?(c.saving=!0,b.post("php/province.php?type=update",{id:a.provincia.i,nome:a.provincia.n,sigla:a.provincia.c,nazione:a.provincia.z,regione:a.provincia.r,trasporto:a.provincia.t,trasporto_type:a.provincia.j,montaggio:a.provincia.m,montaggio_type:a.provincia.k,limite:a.provincia.l,
minimo:a.provincia.b}).success(function(b){a.vm.saveProvinceData();_.each(a.vm.province,function(b){b.i==a.provincia.i&&(b.n=a.provincia.n,b.c=a.provincia.c,b.z=a.provincia.z,b.r=a.provincia.r,b.t=a.provincia.t,b.j=a.provincia.j,b.m=a.provincia.m,b.k=a.provincia.k,b.l=a.provincia.l,b.b=a.provincia.b,a.provincia=angular.copy(b))});c.saving=!1}).error(function(a,b){console.log(b)})):a.errore.provincia=!0);"C"==e&&(_.findWhere(a.vm.province,{n:a.provincia.n,c:a.provincia.c,z:a.provincia.z,r:a.provincia.r})?
...
k:a.provincia.k,l:a.provincia.l,b:a.provincia.b};a.vm.province.push(a.vm.copiedProvincia);a.vm.nuovaProvincia={i:a.vm.nuovaProvincia.i+1};a.vm.saveProvinceData();c.saving=!1;a.errore.provincia=!1}).error(function(a,b){console.log(b)})));"D"==e&&(c.saving=!0,b.post("php/province.php?type=delete",{id:a.provincia.i,nome:a.provincia.n,sigla:a.provincia.c,nazione:a.provincia.z,regione:a.provincia.r,trasporto:a.provincia.t,trasporto_type:a.provincia.j,montaggio:a.provincia.m,montaggio_type:a.provincia.k,
...
angular.module("mpuDashboard").directive("convenzioni",function(){return{restrict:"E",templateUrl:"template/convenzioni.html",scope:{cat:"=",vm:"="},controller:function(a,b,f,c){a.confirm=!1;a.askConfirm=function(){a.confirm=!0;f(function(){a.confirm=!1},4E3)};a.updateCheck=function(){return!a.cat.n};a.action=function(e){"U"==e&&(c.saving=!0,b.post("php/convenzioni.php?type=update",{id:a.cat.i,nome:a.cat.n,email:a.cat.e}).success(function(b){a.vm.saveConvenzioniData();c.saving=!1}).error(function(a,
b){console.log(b)}));"D"==e&&(c.saving=!0,b.post("php/convenzioni.php?type=delete",{id:a.cat.i,nome:a.cat.n,email:a.cat.e}).success(function(b){a.vm.convenzioni=_.filter(a.vm.convenzioni,function(b){return b.i!=a.cat.i});a.vm.saveConvenzioniData();c.saving=!1}).error(function(a,b){console.log(b)}))}}}});
angular.module("mpuDashboard").directive("agenti",function(){return{restrict:"E",templateUrl:"template/agenti.html",scope:{agenteOriginal:"=",vm:"="},controller:function(a,b,f,c){a.$watch("agenteOriginal",function(b){a.agente=angular.copy(b.agente)});a.confirm=!1;a.askConfirm=function(){a.confirm=!0;f(function(){a.confirm=!1},4E3)};a.updateCheck=function(){return!a.agente.n||!a.agente.e||!a.agente.p||!a.agente.r||!a.agente.t};a.newItem=function(){c.saving=!1;a.agenteOriginal.selected=!1;a.vm.nuovoAgente=
{i:a.vm.nuovoAgente.i+1,r:!1}};a.convert=function(b,d,g){var c=[],e="";if("object"===typeof b){for(var k=0;k<b.length;k++)_.each(a.vm[d],function(a){a.i==b[k]&&c.push(a[g])});return c}_.each(a.vm[d],function(a){a.i==b&&(e=a[g])});return e};a.action=function(e){"U"==e&&(c.saving=!0,b.post("php/agenti.php?type=update",{id:a.agente.i,nome:a.agente.n,email:a.agente.e,password:a.agente.p,tel:a.agente.t,riv:a.agente.r}).success(function(b){a.vm.saveAgentiData();_.each(a.vm.agenti,function(b){b.i==a.agente.i&&
(b.n=a.agente.n,b.e=a.agente.e,b.p=a.agente.p,b.t=a.agente.t,b.r=a.agente.r,a.agente=angular.copy(b))});console.log("Risposta dalla pagina PHP",b);c.saving=!1}).error(function(a,b){console.log(b)}));"D"==e&&(c.saving=!0,b.post("php/agenti.php?type=delete",{id:a.agente.i,nome:a.agente.n,email:a.agente.e,password:a.agente.p,tel:a.agente.t,riv:a.agente.r}).success(function(b){a.vm.agenti=_.filter(a.vm.agenti,function(b){return b.i!=a.agente.i});a.vm.saveAgentiData();a.newItem();c.saving=!1}).error(function(a,
b){console.log(b)}))}}}});
angular.module("mpuDashboard").directive("rivenditori",function(){return{restrict:"E",templateUrl:"template/rivenditori.html",scope:{rivenditoreOriginal:"=",vm:"="},controller:function(a,b,f,c){a.errore={rivenditore:!1};a.convert=function(b,g,c){var d=[],e="";if("object"===typeof b){for(var h=0;h<b.length;h++)_.each(a.vm[g],function(a){a.i==b[h]&&d.push(a[c])});return d}_.each(a.vm[g],function(a){a.i==b&&(e=a[c])});return e};a.$watch("rivenditoreOriginal",function(b){a.rivenditore=angular.copy(b.rivenditore);
a.rivenditore.g="../dashboard/archivio_dati/Rivenditori/"+(a.rivenditore.i+".jpg")});a.confirm=!1;a.askConfirm=function(){a.confirm=!0;f(function(){a.confirm=!1},4E3)};a.updateCheck=function(){return(!a.rivenditore.z||!a.rivenditore.r||!a.rivenditore.p)&&!a.rivenditore.v||!a.rivenditore.n||!a.rivenditore.x||!a.rivenditore.s||!a.rivenditore.h&&!a.rivenditore.c||!a.rivenditore.e||!a.rivenditore.w||!a.rivenditore.g};a.copyCheck=function(){return a.rivenditore.v?!a.rivenditore.n||!a.rivenditore.x||!a.rivenditore.s||
!a.rivenditore.t&&!a.rivenditore.c||!a.rivenditore.e||!a.rivenditore.w||a.rivenditore.n===a.rivenditoreOriginal.rivenditore.n:!a.rivenditore.z||!a.rivenditore.r||!a.rivenditore.p||!a.rivenditore.n||!a.rivenditore.x||!a.rivenditore.s||!a.rivenditore.t&&!a.rivenditore.c||!a.rivenditore.e||!a.rivenditore.w||a.rivenditore.p===a.rivenditoreOriginal.rivenditore.p};a.openMarchi=function(){a.vm.mv=!a.vm.mv};var e=function(){a.vm.mv=!1;a.vm.nuovoRivenditore.y=angular.copy(a.vm.marchi);_.each(a.vm.nuovoRivenditore.y,
function(a){a.s=0;delete a.n;delete a.b;delete a.g});return a.vm.nuovoRivenditore.y};e();a.newItem=function(){c.saving=!1;a.errore.rivenditore=!1;a.rivenditoreOriginal.selected=!1;a.vm.nuovoRivenditore={i:a.vm.nuovoRivenditore.i+1,z:!1,r:!1,p:!1,b:0,l:0,t:0,j:1,m:0,k:1,v:!1,c:"",h:"",f:"",a:""};e()};a.action=function(d){if("U"==d){var g=a.rivenditore.p&&a.rivenditore.p!=a.rivenditoreOriginal.rivenditore.p?_.findWhere(a.vm.rivenditori,{p:a.rivenditore.p}):!1;g?a.errore.rivenditore=!0:(c.saving=!0,
...
angular.module("mpuDashboard").directive("esposizioni",function(){return{restrict:"E",templateUrl:"template/esposizioni.html",scope:{esposizioneOriginal:"=",vm:"="},controller:function(a,b,f,c){function e(b){_.each(a.vm.marchi,function(a){a.i==b&&(markByName=a.n)});return markByName}function d(b){_.each(a.vm.linee,function(a){a.i==b&&(lineByName=a.n)});return lineByName}a.errore={esposizione:!1};a.$watch("esposizioneOriginal",function(b){a.esposizione=angular.copy(b.esposizione);b=e(a.esposizione.m);
var c=d(a.esposizione.l);b=b.replace(/ /g,"_");c=c.replace(/ /g,"_");var g=a.esposizione.f.replace(/ /g,"_");a.esposizione.r="../dashboard/archivio_dati/"+b+"/"+c+"/Render/"+(c+"_"+a.esposizione.c+"_"+g+".jpg")});a.confirm=!1;a.askConfirm=function(){a.confirm=!0;f(function(){a.confirm=!1},4E3)};a.updateCheck=function(){return!a.esposizione.c||!a.esposizione.f||!a.esposizione.m||!a.esposizione.l||!a.esposizione.t||!a.esposizione.r||isNaN(a.esposizione.y)};a.deleteCheck=function(){return a.esposizione.c!==
...
a.errore.esposizione=!1;a.esposizioneOriginal.selected=!1;a.vm.nuovoComposto={i:a.vm.nuovaEsposizione.i+1,m:!1,l:!1,t:!1,y:1}};a.action=function(g){if("U"==g){var d=a.esposizione.c!=a.esposizioneOriginal.esposizione.c||a.esposizione.l!=a.esposizioneOriginal.esposizione.l||a.esposizione.f!=a.esposizioneOriginal.esposizione.f?_.findWhere(a.vm.esposizioni,{c:a.esposizione.c,l:a.esposizione.l,f:a.esposizione.f}):!1;d?a.errore.esposizione=!0:(c.saving=!0,b.post("php/esposizioni.php?type=update",{id:a.esposizione.i,
...
angular.module("mpuDashboard").directive("composti",function(){return{restrict:"E",templateUrl:"template/composti.html",scope:{compostoOriginal:"=",vm:"="},controller:function(a,b,f,c){function e(b){_.each(a.vm.marchi,function(a){a.i==b&&(markByName=a.n)});return markByName}function d(b){_.each(a.vm.linee,function(a){a.i==b&&(lineByName=a.n)});return lineByName}a.errore={composto:!1};a.$watch("compostoOriginal",function(b){a.composto=angular.copy(b.composto);b=e(a.composto.m);var c=d(a.composto.l);
b=b.replace(/ /g,"_");c=c.replace(/ /g,"_");var g=a.composto.f.replace(/ /g,"_");a.composto.r="../dashboard/archivio_dati/"+b+"/"+c+"/Render/"+(c+"_"+a.composto.c+"C_"+g+".jpg")});a.confirm=!1;a.askConfirm=function(){a.confirm=!0;f(function(){a.confirm=!1},4E3)};a.updateCheck=function(){return!a.composto.c||!a.composto.f||!a.composto.m||!a.composto.l||!a.composto.n||!a.composto.r||isNaN(a.composto.y)};a.deleteCheck=function(){return a.composto.c!==a.compostoOriginal.composto.c||a.composto.m!==a.compostoOriginal.composto.m||
a.composto.l!==a.compostoOriginal.composto.l||a.composto.f!==a.compostoOriginal.composto.f};a.copyCheck=function(){return!a.composto.c||!a.composto.m||!a.composto.l||!a.composto.f||a.composto.c===a.compostoOriginal.composto.c&&a.composto.l===a.compostoOriginal.composto.l&&a.composto.f===a.compostoOriginal.composto.f};a.newItem=function(){c.saving=!1;a.errore.composto=!1;a.compostoOriginal.selected=!1;a.vm.nuovoComposto={i:a.vm.nuovoComposto.i+1,m:!1,l:!1,y:1}};a.action=function(d){if("U"==d){var g=
a.composto.c!=a.compostoOriginal.composto.c||a.composto.l!=a.compostoOriginal.composto.l||a.composto.f!=a.compostoOriginal.composto.f?_.findWhere(a.vm.composti,{c:a.composto.c,l:a.composto.l,f:a.composto.f}):!1;g?a.errore.composto=!0:(c.saving=!0,b.post("php/composti.php?type=update",{id:a.composto.i,mark:a.composto.m,line:a.composto.l,cod:a.composto.c,fin:a.composto.f,pos:a.composto.y,nome:a.composto.n,image:a.composto.r,sourceCod:a.compostoOriginal.composto.c,sourceMark:a.compostoOriginal.composto.m,
sourceLine:a.compostoOriginal.composto.l,sourceFin:a.compostoOriginal.composto.f}).success(function(b){a.errore.composto=!1;a.vm.saveCompostoData();console.log("Risposta dalla pagina PHP",b);_.each(a.vm.composti,function(b){b.i==a.composto.i&&(b.m=a.composto.m,b.l=a.composto.l,b.c=a.composto.c,b.f=a.composto.f,b.y=a.composto.y,b.n=a.composto.n,b.r=a.composto.r,a.composto=angular.copy(b))});c.saving=!1;a.errore.composto=!1}).error(function(a,b){console.log(b)}))}"C"==d&&(_.findWhere(a.vm.composti,
...
b);a.vm.copiedComposto={i:a.vm.nuovoComposto.i,m:a.composto.m,l:a.composto.l,c:a.composto.c,f:a.composto.f,y:a.composto.y,n:a.composto.n};a.vm.composti.push(a.vm.copiedComposto);a.vm.nuovoComposto={i:a.vm.nuovoComposto.i+1};a.vm.saveCompostoData();c.saving=!1;a.errore.composto=!1}).error(function(a,b){console.log(b)})));"D"==d&&(c.saving=!0,b.post("php/composti.php?type=delete",{id:a.composto.i,mark:a.composto.m,line:a.composto.l,cod:a.composto.c,fin:a.composto.f,pos:a.composto.y,nome:a.composto.n,
...
angular.module("mpuDashboard").directive("esposizioniProdotti",function(){return{restrict:"E",templateUrl:"template/esposizioniProdotti.html",scope:{esposizioneProdottoOriginal:"=",vm:"="},controller:function(a,b,f,c){a.$watch("esposizioneProdottoOriginal",function(b){a.esposizioneProdotto=angular.copy(b.esposizioneProdotto)});a.confirm=!1;a.askConfirm=function(){a.confirm=!0;f(function(){a.confirm=!1},4E3)};a.$watch("esposizioneProdotto.p",function(b,c){b!=c&&a.esposizioneProdottoOriginal.i==a.esposizioneProdotto&&
(a.esposizioneProdotto.u=!1);if(b){b=_.findWhere(a.vm.prodotti,{i:b});b=_.pluck(b.z,"a");a.tabsAvailable=[];for(c=0;c<b.length;c++){var d=_.findWhere(a.vm.finitureTabelle,{i:b[c]});a.tabsAvailable.push({i:b[c],n:d.n})}return a.tabsAvailable}});a.$watch("esposizioneProdotto.u",function(b,c){b!=c&&a.esposizioneProdottoOriginal.i==a.esposizioneProdotto&&(a.esposizioneProdotto.f=!1);if(b)return a.finsAvailable=_.where(a.vm.abbinamenti,{u:b}),a.finsAvailable});a.newItem=function(){c.saving=!1;a.esposizioneProdotto=
{i:a.vm.nuovoEsposizioneProdotto.i+1,c:!1,p:!1,m:!1,k:!1,l:!1,j:!1,u:!1,f:!1,y:1,q:1}};a.updateCheck=function(){return!a.esposizioneProdotto.c||!a.esposizioneProdotto.p||!a.esposizioneProdotto.l||!a.esposizioneProdotto.j||!a.esposizioneProdotto.u||!a.esposizioneProdotto.f||isNaN(a.esposizioneProdotto.y)||isNaN(a.esposizioneProdotto.q)};a.action=function(e){"U"==e&&(c.saving=!0,b.post("php/esposizioniProdotti.php?type=update",{id:a.esposizioneProdotto.i,comp:a.esposizioneProdotto.c,prd:a.esposizioneProdotto.p,
...
a.vm.esposizioniProdotti.push(a.vm.copiedEsposizioneProdotto);a.vm.nuovoEsposizioneProdotto={i:a.vm.nuovoEsposizioneProdotto.i+1};a.vm.saveEsposizioniProdottiData();c.saving=!1}).error(function(a,b){console.log(b)}));"D"==e&&(c.saving=!0,b.post("php/esposizioniProdotti.php?type=delete",{id:a.esposizioneProdotto.i,comp:a.esposizioneProdotto.c,prd:a.esposizioneProdotto.p,pline:a.esposizioneProdotto.l,cline:a.esposizioneProdotto.j,pmark:a.esposizioneProdotto.m,cmark:a.esposizioneProdotto.k,fin:a.esposizioneProdotto.f,
...
angular.module("mpuDashboard").directive("compostiProdotti",function(){return{restrict:"E",templateUrl:"template/compostiProdotti.html",scope:{compostoProdottoOriginal:"=",vm:"="},controller:function(a,b,f,c){a.$watch("compostoProdottoOriginal",function(b){a.compostoProdotto=angular.copy(b.compostoProdotto)});a.confirm=!1;a.askConfirm=function(){a.confirm=!0;f(function(){a.confirm=!1},4E3)};a.$watch("compostoProdotto.p",function(b,c){b!=c&&a.compostoProdottoOriginal.i==a.compostoProdotto&&(a.compostoProdotto.u=
...
1,c:!1,p:!1,m:!1,k:!1,l:!1,j:!1,u:!1,f:!1,y:1,q:1}};a.updateCheck=function(){return!a.compostoProdotto.c||!a.compostoProdotto.p||!a.compostoProdotto.l||!a.compostoProdotto.j||!a.compostoProdotto.u||!a.compostoProdotto.f||isNaN(a.compostoProdotto.y)||isNaN(a.compostoProdotto.q)};a.action=function(e){"U"==e&&(c.saving=!0,b.post("php/compostiProdotti.php?type=update",{id:a.compostoProdotto.i,comp:a.compostoProdotto.c,prd:a.compostoProdotto.p,pline:a.compostoProdotto.l,cline:a.compostoProdotto.j,pmark:a.compostoProdotto.m,
...
angular.module("mpuDashboard").directive("esposizioniSettori",function(){return{restrict:"E",templateUrl:"template/esposizioniSettori.html",scope:{esposizioneSettoreOriginal:"=",vm:"="},controller:function(a,b,f,c,e){a.$watch("esposizioneSettoreOriginal",function(b){a.esposizioneSettore=angular.copy(b.esposizioneSettore)});a.saveDataDB=function(){c.saving=!0;b.post("php/esposizioniSettori.php?type=db").success(function(){c.saving=!1;e.esposizioniSettori().then(function(b){a.vm.esposizioniSettori=
b})}).error(function(a,b){console.log(b)})};a.errore={esposizioneSettore:!1};a.confirm=!1;a.askConfirm=function(){a.confirm=!0;f(function(){a.confirm=!1},4E3)};a.convert=function(b,c,e){var d="";_.each(a.vm[c],function(a){a.i==b&&(d=a[e])});return d};a.$watch("esposizioneSettore",function(b){a.esposizioniAvailable=[{c:" Tutti",i:-1},{c:a.convert(a.esposizioneSettore.c,"esposizioni","c")+"_"+a.convert(a.esposizioneSettore.c,"esposizioni","f"),i:a.esposizioneSettore.c}];var c=_.where(a.vm.esposizioni,
...
!1;a.esposizioneSettoreOriginal.selected=!1;a.vm.nuovoEsposizioneSettore={i:a.vm.nuovoEsposizioneSettore.i+1,m:!1,l:!1,c:!1,v:0,h:[]}};a.action=function(d){"U"==d&&(0!=a.esposizioneSettore.h.length?(c.saving=!0,b.post("php/esposizioniSettori.php?type=update",{id:a.esposizioneSettore.i,cod:a.esposizioneSettore.c,mark:a.esposizioneSettore.m,line:a.esposizioneSettore.l,nwln:a.esposizioneSettore.w,array:a.esposizioneSettore.h,view:a.esposizioneSettore.v}).success(function(b){_.each(a.vm.esposizioniSettori,
function(b,c){b.i==a.esposizioneSettore.i&&(b.c=a.esposizioneSettore.c,b.n=a.esposizioneSettore.n,b.m=a.esposizioneSettore.m,b.l=a.esposizioneSettore.l,b.w=a.esposizioneSettore.w,b.h=a.esposizioneSettore.h,b.v=a.esposizioneSettore.v,a.esposizioneSettore=angular.copy(b))});c.saving=!1;a.errore.esposizioneSettore=!1;a.vm.saveEsposizioneSettoreData()}).error(function(a,b){console.log(b)})):a.errore.esposizioneSettore=!0);"C"==d&&(0!=a.esposizioneSettore.h.length?(c.saving=!0,b.post("php/esposizioniSettori.php?type=new",
...
a.vm.nuovoEsposizioneSettore={i:a.vm.nuovoEsposizioneSettore.i+1};a.vm.saveEsposizioneSettoreData();c.saving=!1;a.errore.esposizioneSettore=!1}).error(function(a,b){console.log(b)})):a.errore.esposizioneSettore=!0);"D"==d&&(c.saving=!0,b.post("php/esposizioniSettori.php?type=delete",{id:a.esposizioneSettore.i,cod:a.esposizioneSettore.c,mark:a.esposizioneSettore.m,line:a.esposizioneSettore.l,nwln:a.esposizioneSettore.w,view:a.esposizioneSettore.v,array:a.esposizioneSettore.h}).success(function(b){-1!=
...
angular.module("mpuDashboard").directive("compostiSettori",function(){return{restrict:"E",templateUrl:"template/compostiSettori.html",scope:{compostoSettoreOriginal:"=",vm:"="},controller:function(a,b,f,c,e){a.$watch("compostoSettoreOriginal",function(b){a.compostoSettore=angular.copy(b.compostoSettore)});a.saveDataDB=function(){c.saving=!0;b.post("php/compostiSettori.php?type=db").success(function(){c.saving=!1;e.compostiSettori().then(function(b){a.vm.compostiSettori=b})}).error(function(a,b){console.log(b)})};
a.errore={compostoSettore:!1};a.confirm=!1;a.askConfirm=function(){a.confirm=!0;f(function(){a.confirm=!1},4E3)};a.convert=function(b,c,e){var d="";_.each(a.vm[c],function(a){a.i==b&&(d=a[e])});return d};a.$watch("compostoSettore",function(b){a.compostiAvailable=[{c:" Tutti",i:-1},{c:a.convert(a.compostoSettore.c,"composti","c")+"_"+a.convert(a.compostoSettore.c,"composti","f"),i:a.compostoSettore.c}];var c=_.where(a.vm.composti,{l:a.compostoSettore.l});_.each(c,function(c){_.find(a.vm.compostiSettori,
